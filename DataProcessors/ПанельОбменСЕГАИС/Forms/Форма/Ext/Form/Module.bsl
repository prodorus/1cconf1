...
Процедура ПараметрыПодключенияКЕГАИС(Команда)
	...
	ОткрытьФормуЕГАИС("РегистрСведений.НастройкиОбменаЕГАИС.ФормаСписка", , ЭтаФорма);
...
Процедура КлассификаторАлкогольнойПродукцииЕГАИС(Команда)
	...
	ОткрытьФормуЕГАИС("Справочник.КлассификаторАлкогольнойПродукцииЕГАИС.ФормаСписка", , ЭтаФорма);
...
Процедура ВидыАлкогольнойПродукции(Команда)
	...
	ОткрытьФормуЕГАИС("Справочник.ВидыАлкогольнойПродукции.ФормаСписка", , ЭтаФорма);
...
Процедура КлассификаторОрганизацийЕГАИС(Команда)
	...
	ОткрытьФормуЕГАИС("Справочник.КлассификаторОрганизацийЕГАИС.ФормаСписка", , ЭтаФорма);
...
Процедура Справки1ЕГАИС(Команда)
	...
	ОткрытьФормуЕГАИС("Справочник.Справки1ЕГАИС.ФормаСписка", , ЭтаФорма);
...
Процедура Справки2ЕГАИС(Команда)
	...
	ОткрытьФормуЕГАИС("Справочник.Справки2ЕГАИС.ФормаСписка", , ЭтаФорма);
...
Процедура ШтрихкодыУпаковок(Команда)
	...
	ОткрытьФормуЕГАИС("Справочник.ШтрихкодыУпаковокТоваров.ФормаСписка", , ЭтаФорма);
...
Процедура ОткрытьПротоколОбменаЕГАИС(Команда)
	...
	ОткрытьФормуЕГАИС("Справочник.ЕГАИСПрисоединенныеФайлы.Форма.ФормаСписка", ПараметрыФормы);
...
Процедура ОткрытьWebИнтерфейсУТМ(Команда)
	...
	ИначеЕсли ОрганизацииЕГАИС.Количество() > 1 Тогда
		...
		ВыбраннаяОрганизация = ОрганизацииЕГАИС.ВыбратьЭлемент(НСтр("ru = 'Выбор организации ЕГАИС'"),ОрганизацииЕГАИС.Получить(0).Значение);
...
Процедура ОткрытьНастройкиРежимаОтладки(Команда)
	...
	ОткрытьФормуЕГАИС("Обработка.ПанельОбменСЕГАИС.Форма.НастройкиРежимаОтладки");
...
Процедура ОткрытьФормуСпискаДокументов(ИмяФормы,
	...
	ОткрытьФормуЕГАИС(ИмяФормы, ПараметрыФормы,,,,,);
