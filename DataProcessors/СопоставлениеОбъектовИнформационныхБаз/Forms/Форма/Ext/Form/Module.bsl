...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//         -1 - не сопоставленный объект источника
	//         +1 - не сопоставленный объект приемника
	//          3 - сопоставленная, но не утвержденная связь
	//
...
Процедура УстановитьСвязьИнтерактивно()
	...
	Если Не (
		    ТекущиеДанные.СтатусСопоставления=-1	// Не сопоставленный объект источника
		Или ТекущиеДанные.СтатусСопоставления=+1	// Не сопоставленный объект приемника
	) Тогда
...
Функция УстановитьСвязьБыстро()
	...
	Если Не (
		(
			  Строка1.СтатусСопоставления = -1 // Не сопоставленный объект источника
			И Строка2.СтатусСопоставления = +1 // Не сопоставленный объект приемника
		) Или (
			  Строка1.СтатусСопоставления = +1 // Не сопоставленный объект приемника
			И Строка2.СтатусСопоставления = -1 // Не сопоставленный объект источника
		) )
	Тогда
		Возврат Ложь;
	КонецЕсли;
