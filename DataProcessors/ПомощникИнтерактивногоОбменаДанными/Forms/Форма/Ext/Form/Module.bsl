...
Процедура ВидТранспортаСообщенийОбменаПриИзмененииНаСервере()
	...
	Иначе
		...
		Элементы.ИнформационнаяНадписьНастройкиРасписания.Видимость = Не УзелИспользуетсяВСценарииОбмена И ПользователиСервер.РолиДоступны("НастройкаСинхронизацииДанных");
		
		ОткрытьПомощникСозданияСценарияОбменаДанными = ПользователиСервер.РолиДоступны("НастройкаСинхронизацииДанных");
...
Процедура ОбновитьСтраницыНастроекТранспорта()
	...
	РольДоступнаДобавлениеИзменениеОбменовДанными = ПользователиСервер.РолиДоступны("НастройкаСинхронизацииДанных");
