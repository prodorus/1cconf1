...
Функция ВыполнитьДвижениеДенег(СтруктураПараметров, СформированныеДвижения, СтруктураШапкиДокумента, УдаляемыеВидыРегОпераций)
	...
	БухгалтерскийУчетРасчетовСКонтрагентами.БухгалтерскийУчетРасчетыСКонтрагентами_Оплата(СтруктураПараметров, СтруктураШапкиДокумента, СформированныеДвижения, ОшибкаПриФормированииДвижений, СтруктураПараметров.Заголовок,,Истина,УдаляемыеВидыРегОпераций, мКэшВидовСубконтоПоСчетам, Истина);
