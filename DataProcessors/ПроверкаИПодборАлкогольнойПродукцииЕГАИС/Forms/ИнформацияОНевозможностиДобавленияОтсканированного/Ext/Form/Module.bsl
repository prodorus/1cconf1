...
&НаКлиенте
Процедура ДекорацияОшибкаДобавленияАлкогольнойПродукцииОбработкаНавигационнойСсылки(Элемент, СтандартнаяОбработка)
	
	СтандартнаяОбработка = Ложь;
	НавигационнаяСсылкаФорматированнойСтроки = ИнтеграцияЕГАИСУТКлиентСервер.НавигационнаяСсылкаСтроки(Элемент, ОшибкаДобавленияАлкогольнойПродукции);
...
Процедура ПоказатьИнформациюОПроблемахСАлкогольнойПродукцией(ИнформацияВДереве)
	...
	СтрокаШтриховойКод = ФорматированнаяСтрока(ИнтеграцияЕГАИСКлиентСервер.ПредставлениеШтрихкода(ЗначениеШтрихКода),
	                                                 Новый Шрифт(,,,,Истина),
	...
	МассивСтрок.Добавить(СтрокаШтриховойКод);
	МассивСтрок.Добавить(ТекстСОшибкой);
	
	ОшибкаДобавленияАлкогольнойПродукции = Новый ФиксированныйМассив(МассивСтрок);
	
	ИнтеграцияЕГАИСУТ.СформироватьФорматированнуюСтроку(ЭтаФорма,
		ОшибкаДобавленияАлкогольнойПродукции,
		"ГруппаГруппаОшибкаДобавленияАлкогольнойПродукции",
		"ДекорацияОшибкаДобавленияАлкогольнойПродукцииОбработкаНавигационнойСсылки");
