...
Процедура ПередЗаписью(Отказ)
	...
	Если ОбменДанными.Загрузка ИЛИ ЭтотОбъект.ПометкаУдаления Тогда
		Возврат;
	КонецЕсли;
	
	ЭтоПБОЮЛ = РегламентированнаяОтчетность.ЭтоПБОЮЛ(Владелец);
