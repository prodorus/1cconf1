...
Процедура ПередЗаписью(Отказ)
	...
	Если Не ОтдельныйСчетГОЗ Тогда
		ГосударственныйКонтракт = Справочники.ГосударственныеКонтракты.ПустаяСсылка();
	КонецЕсли;
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	Если Не ОтдельныйСчетГОЗ Тогда
		ИндексГК = ПроверяемыеРеквизиты.Найти("ГосударственныйКонтракт");
		Если ИндексГК <> Неопределено Тогда
			ПроверяемыеРеквизиты.Удалить(ИндексГК);
		КонецЕсли;
	КонецЕсли;
КонецПроцедуры
