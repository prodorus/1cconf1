...
Функция ХешСуммаСодержимогоУпаковки(ДанныеДляВычисления) Экспорт
	...
	Возврат Base64Строка(ХешированиеДанныхЕГАИС("SHA256", СтрокаДляРасчетаХеша));
...
Функция ПараметрыМакетовДляПечати() Экспорт
	Параметры = Новый Структура;
	Параметры.Вставить("Макет_SSCC",           ПолучитьМакет("SSCC"));
	Параметры.Вставить("Макет_Code128Формат1", ПолучитьМакет("Code128Формат1"));
	Параметры.Вставить("Макет_Code128Формат2", ПолучитьМакет("Code128Формат2"));
	Параметры.Вставить("Макет_Code128Формат3", ПолучитьМакет("Code128Формат3"));
	Параметры.Вставить("Макет_GS1_128",        ПолучитьМакет("GS1_128"));
	Параметры.Вставить("Макет_DataBar",        ПолучитьМакет("GS1DataBarExpandedStacked"));
	Параметры.Вставить("Макет_PDF417",         ПолучитьМакет("PDF417"));
