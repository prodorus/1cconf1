...
Процедура ПередЗаписью(Отказ)
	...
	//////		Наименование = Сред(ЗначениеШтрихкода,4,11);
	//////	ИначеЕсли ТипШтрихкода = Перечисления.ТипыШтрихкодов.PDF417 Тогда
	//////		Наименование = Сред(ЗначениеШтрихкода,20, 18);
	//////	ИначеЕсли ЗначениеЗаполнено(ЗначениеШтрихкода) Тогда
	//////		Наименование = ЗначениеШтрихкода;
	//////	Иначе 
	//////		Наименование = НСтр("ru = 'Штрихкод не указан'");
	//////	КонецЕсли;
	//////Иначе 
