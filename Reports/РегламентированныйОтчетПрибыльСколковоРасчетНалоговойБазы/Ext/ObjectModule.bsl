...
Перем мПроверятьСоотношенияПриПечатиИВыгрузки Экспорт; // флаг для запуска контроля соотношений
...
Форма20111001 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1150022", '20101230', "196н", "ФормаОтчета2011Кв3");
