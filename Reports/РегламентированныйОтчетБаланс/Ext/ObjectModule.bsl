...
Форма20030101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "710001", '20030722', "67н", "ФормаОтчета2003Кв4");
...
НоваяФорма.ОписаниеОтчета     = "Утвержден приказом Минфина России от 22.07.2003 г. №67н";
