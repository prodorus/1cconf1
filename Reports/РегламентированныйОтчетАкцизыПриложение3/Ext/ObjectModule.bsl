...
Форма20040101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151005", '20031210', "БГ-3-03/675@",	"ФормаОтчета2004Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20040101, "3.00004");

Форма20050301 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151005", '20050303', "32н",			"ФормаОтчета2005Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20050301, "3.00005");

Форма20060101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151005", '20051230', "168н",			"ФормаОтчета2006Кв1");
...
НоваяФорма.ОписаниеОтчета     = "Приложение № 3 к приказу Минфина России от 03.03.2005 г. № 32н";
НоваяФорма.ДатаНачалоДействия = '20050301';
НоваяФорма.ДатаКонецДействия  = '2006-02-28';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2006Кв1";
НоваяФорма.ОписаниеОтчета     = "Приложение № 3 к приказу Минфина России от 03.03.2005 г. № 32н (в редакции приказа Минфина России от 30.12.2005 г. №168н)";
