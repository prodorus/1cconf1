...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	НастройкиСводногоОтчета = КомпоновщикНастроек.Настройки;
	
	Для каждого ЭлементФиксированнойНастройки Из КомпоновщикНастроек.ФиксированныеНастройки.ПараметрыДанных.Элементы Цикл
		
		ПараметрДанных = НастройкиСводногоОтчета.ПараметрыДанных.Элементы.Найти(Строка(ЭлементФиксированнойНастройки.Параметр));
		Если ПараметрДанных <> Неопределено Тогда
			ПараметрДанных.Значение = ЭлементФиксированнойНастройки.Значение;
		КонецЕсли;
