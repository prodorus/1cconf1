...
Форма20050101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151073", '20050317', "42н", "ФормаОтчета2005Кв1");
...
НоваяФорма.ОписаниеОтчета     = "Приложение №1 к Приказу Минфина РФ  от 17.03.2005 г. № 42н";
