...
ФормаОтчета2005Кв1 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151059", '2005-03-28', "50н", "ФормаОтчета2005Кв1");
ОпределитьФорматВДеревеФормИФорматов(ФормаОтчета2005Кв1, "3.00002");

ФормаОтчета2007Кв1 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151059", '2006-12-19', "178н", "ФормаОтчета2007Кв1");
ОпределитьФорматВДеревеФормИФорматов(ФормаОтчета2007Кв1, "3.00003");

ФормаОтчета2008Кв1 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151059", '2007-10-15', "88н", "ФормаОтчета2008Кв1");
ОпределитьФорматВДеревеФормИФорматов(ФормаОтчета2008Кв1, "3.00004");

ФормаОтчета2009Кв1 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151059", '2009-06-22', "57н", "ФормаОтчета2009Кв1");
ОпределитьФорматВДеревеФормИФорматов(ФормаОтчета2009Кв1, "5.01", , , , '2013-12-31');
ОпределитьФорматВДеревеФормИФорматов(ФормаОтчета2009Кв1, "5.02", , , '2014-01-01');

ФормаОтчета2014Кв1 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151059", '2014-07-28', "ММВ-7-3/384@", "ФормаОтчета2014Кв1");
ОпределитьФорматВДеревеФормИФорматов(ФормаОтчета2014Кв1, "5.03");

ФормаОтчета2015Кв1 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151059", '2016-02-01', "ММВ-7-3/51@", "ФормаОтчета2015Кв1");
...
НоваяФорма.ОписаниеОтчета     = "Приложение №1 к Приказу Минфина РФ от 28.03.2005 №50н";
НоваяФорма.ДатаНачалоДействия = '2005-01-01';
НоваяФорма.ДатаКонецДействия  = '2006-12-31';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2007Кв1";
НоваяФорма.ОписаниеОтчета     = "Утверждена приказом Минфина РФ от 28.03.2005 №50н (в ред. приказа Минфина РФ от 19.12.2006 № 178н)";
НоваяФорма.ДатаНачалоДействия = '2007-01-01';
НоваяФорма.ДатаКонецДействия  = '2007-12-31';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2008Кв1";
НоваяФорма.ОписаниеОтчета     = "Утверждена приказом Минфина РФ от 28.03.2005 №50н (в ред. приказов Минфина РФ от 19.12.2006 № 178н, от 15.10.2007 № 88н)";
