...
Форма2015Кв4 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1155116", '2015-09-30', "ММВ-7-15/427", "ФормаОтчета2015Кв4");
...
НоваяФорма.ОписаниеОтчета     = "Приложение № 13 к приказу ФНС России от 30.09.2015 № ММВ-7-15/427.";
