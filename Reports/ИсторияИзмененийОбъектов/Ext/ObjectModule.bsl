	...
	Для Каждого ЭлементМодРеквизит Из ТаблицаИзмененийРеквизитов Цикл
		Если ЭлементМодРеквизит._Модификация = Истина Тогда
			...
			Если ОписаниеРеквизита = Неопределено Тогда
				...
				ИначеЕсли НаименованиеРеквизита = "Parent" Тогда
					ОписаниеРеквизита = Новый Структура("Тип", Новый ОписаниеТипов("СправочникСсылка."+СсылкаНаОбъект.Метаданные().Имя));
					
				Иначе
					ОписаниеРеквизита = Новый Структура("Тип", Новый ОписаниеТипов("Неопределено"));
			...
			ИначеЕсли (УровеньЧтения = 4) Тогда // значение реквизита
				...
				Если ТипЗначенияПоляТЧ = "" Тогда
					...
					Если ОписаниеРТЧ = Неопределено Тогда
						Для Каждого СтандартныйРеквизит Из ТабличныеЧастиМТД[ИмяТабличнойЧасти].СтандартныеРеквизиты Цикл
							Если СтандартныйРеквизит.Имя = ИмяПоляТЧ Тогда
								ОписаниеРТЧ = СтандартныйРеквизит;
								Прервать;
							КонецЕсли;
						КонецЦикла;
					КонецЕсли;
