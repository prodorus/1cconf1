...
Форма20050401 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1-квот", '20050608', "137",	"ФормаОтчета2005Кв2");
Форма20091001 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1-квот", '20091001', "277",	"ФормаОтчета2009Кв3");
Форма20120101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1-квот", '20120301', "119",	"ФормаОтчета2012Кв1");
Форма20130701 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1-квот", '20130829', "449",	"ФормаОтчета2013Кв3");
Форма20130701 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1-квот", '20150720', "385",	"ФормаОтчета2015Кв2");
Форма20130701 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1-квот", '20170201', "72",		"ФормаОтчета2017Кв1");
Форма20130701 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1-квот", '20171214', "1532",	"ФормаОтчета2018Кв1");
...
НоваяФорма.ОписаниеОтчета     = "Введена Комитетом общественных связей города Москвы, согласована с Мосгоркомстатом";
НоваяФорма.ДатаНачалоДействия = '20050101';
НоваяФорма.ДатаКонецДействия  = '20050930'; // по III квартал

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2005Кв2";
НоваяФорма.ОписаниеОтчета     = "Введена Комитетом общественных связей города Москвы. Приказ от 08.06.2005 № 137";
НоваяФорма.ДатаНачалоДействия = '20050401'; // Введена в действие с отчета за II квартал 2005 года
НоваяФорма.ДатаКонецДействия  = '20090630';
...
НоваяФорма.ДатаНачалоДействия = '20150701'; // Введена в действие с отчета за III квартал 2013 года
...
НоваяФорма.ДатаНачалоДействия = '20170101'; // Введена в действие с отчета за III квартал 2013 года
...
НоваяФорма.ДатаНачалоДействия = '20180101'; // Введена в действие с отчета за III квартал 2013 года
