...
// Определение форм.
Форма20120101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "607019", '20110719', "328", "ФормаОтчета2012Кв1");
Форма20120101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "607019", '20140827', "536", "ФормаОтчета2015Кв1");
РегламентированнаяОтчетность.ОпределитьФорматВДеревеФормИФорматов(Форма20120101, "15-10-2015");
Форма20150101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "607019", '20160706', "327", "ФормаОтчета2016Кв1");
РегламентированнаяОтчетность.ОпределитьФорматВДеревеФормИФорматов(Форма20150101, "05-12-2017");
