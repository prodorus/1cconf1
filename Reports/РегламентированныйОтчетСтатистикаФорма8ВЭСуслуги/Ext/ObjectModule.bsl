...
// Следующие переменные хранят границы периода
// построения отчета и периодичность.
...
// Определение форм.
Форма20130101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "613034", '20120727', "421", "ФормаОтчета2013Кв1");
Форма20140101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "613034", '20130809', "317", "ФормаОтчета2014Кв1");
Форма20140102 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "613034", '20130913', "367", "ФормаОтчета2014Кв2");
РегламентированнаяОтчетность.ОпределитьФорматВДеревеФормИФорматов(Форма20140102, "25-12-2017");
