...
Процедура ВыполнитьСравнительныйЗапросНДСПредъявленПоставщиком(РезультирующаяТаблица)
	...
	ТекстЗапроса = 
		...
		|	ГДЕ
		|		ВЫБОР
		|			КОГДА НДСПредъявленныйОбороты.СуммаБезНДСПриход > НДСПредъявленныйОбороты.СуммаБезНДСРасход
		|				ТОГДА (НДСПредъявленныйОбороты.СуммаБезНДСРасход + НДСПредъявленныйОбороты.НДСРасход = 0
