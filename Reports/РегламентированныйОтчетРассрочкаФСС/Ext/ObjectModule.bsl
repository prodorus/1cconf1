...
// Определение форм.
Форма20150101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "000000", '20170425', "196", "ФормаОтчета2017Кв1");
...
НоваяФорма.ОписаниеОтчета     = "Форма утверждена приказом ФСС РФ от 25.04.2017 №196.";
