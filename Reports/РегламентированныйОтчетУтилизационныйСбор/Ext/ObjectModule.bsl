...
ФормаОтчета2014Кв1 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151091", '2013-12-25', "ГД-4-3/23318@", "ФормаОтчета2014Кв1");
ОпределитьФорматВДеревеФормИФорматов(ФормаОтчета2014Кв1, "5.01");

ФормаОтчета2014Кв3 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151091", '2014-06-23', "ММВ-7-3/327@", "ФормаОтчета2014Кв3");
ОпределитьФорматВДеревеФормИФорматов(ФормаОтчета2014Кв3, "5.02");

ФормаОтчета2016Кв1 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151091", '2016-02-16', "СД-4-3/2437@", "ФормаОтчета2016Кв1");
ОпределитьФорматВДеревеФормИФорматов(ФормаОтчета2016Кв1, "5.03");

ФормаОтчета2016Кв4 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151091", '2016-10-24', "ММВ-7-3/577@", "ФормаОтчета2016Кв4");
...
НоваяФорма.ОписаниеОтчета     = "Приложение №1 к приказу ФНС России от 23.06.2014 № ММВ-7-3/327@";
НоваяФорма.ДатаНачалоДействия = '2014-01-01';
НоваяФорма.ДатаКонецДействия  = '2014-01-01';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2016Кв1";
НоваяФорма.ОписаниеОтчета     = "Приложение к письму ФНС России от 16.02.2016 № СД-4-3/2437@";
НоваяФорма.ДатаНачалоДействия = '2014-01-01';
НоваяФорма.ДатаКонецДействия  = '2014-01-01';
