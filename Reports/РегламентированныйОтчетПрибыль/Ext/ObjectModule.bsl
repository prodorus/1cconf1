...
ФормаОтчета2016Кв4 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151006", '2016-10-19', "ММВ-7-3/572@", "ФормаОтчета2016Кв4");
ОпределитьФорматВДеревеФормИФорматов(ФормаОтчета2016Кв4, "5.07");
