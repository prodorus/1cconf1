...
Форма20040101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151024", '2003-12-23', "БГ-3-23/709@", "ФормаОтчета2004Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20040101, "3.00002");

Форма20070301 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151024", '2003-12-23', "БГ-3-23/709@", "ФормаОтчета2007Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20070301, "3.00003");

Форма20120701 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151024", '2003-12-23', "БГ-3-23/709@", "ФормаОтчета2012Кв3");
...
НоваяФорма.ОписаниеОтчета     = "Приложение № 1 Утверждено Приказом МНС России от 23.12.2003 г. №БГ-3-23/709";
...
НоваяФорма.ДатаКонецДействия  = '2012-07-31';
...
НоваяФорма.ДатаНачалоДействия = '2012-08-01';
