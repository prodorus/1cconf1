...
Форма20040701 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1110006", '2004-04-05', "САЭ-3-21/261@", "ФормаОтчета2004Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20040701, "3.00000");

Форма20060401 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1110012", '2006-02-26', "САЭ-3-21/109@", "ФормаОтчета2006Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20060401, "3.00001");

Форма2013Кв4 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1110012", '2013-11-14', "ММВ-7-3/501@", "ФормаОтчета2013Кв4");
...
НоваяФорма.ОписаниеОтчета     = "Приказ МНС РФ от 05.04.2004 №САЭ-3-21/261";
