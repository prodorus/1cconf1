...
Форма20120701 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1152025", '2012-08-09', "815", "ФормаОтчета2012Кв3");
...
НоваяФорма.ОписаниеОтчета     = "Приложение 7 к Положению о представлении декларации об объемах производства, оборота и использования этилового спирта, алкогольной и спиртосодержащей продукции (Утверждено Постановлением Правительства РФ от 31.12.2005  № 858)";
...
НоваяФорма.ОписаниеОтчета     = "Приложение 7 к Положению о представлении декларации об объемах производства, оборота и использования этилового спирта, алкогольной и спиртосодержащей продукции (Утверждено ПП РФ от 31.12.2005 № 858) (выгрузка в формате 3.02)";
НоваяФорма.ДатаНачалоДействия = '20060101';
...
НоваяФорма.НарастающийИтог    = Ложь;
НоваяФорма.НаименованиеОтчета = "Закупка этилового спирта, алкогольной и спиртосодержащей продукции";
