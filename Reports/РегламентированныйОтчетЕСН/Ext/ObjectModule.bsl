...
Форма20040101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151046", '20050210', "21н",			"ФормаОтчета2004Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20040101, "3.00000");

Форма20050101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151046", '20060111', "03-05-02-03/1",	"ФормаОтчета2005Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20050101, "3.00001");

Форма20050101_2 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151046", '20060131', "19н",			"ФормаОтчета2006Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20050101_2, "3.00002");

Форма20070101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151046", '20071229', "163н",			"ФормаОтчета2007Кв1");
...
НоваяФорма.ОписаниеОтчета     = "Форма утверждена приказом Минфина РФ от 29.12.2007 г. №163н";
