...
ФормаОтчета2005Кв1 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151038", '2004-01-05', "БГ-3-23/1", "ФормаОтчета2005Кв1");
ОпределитьФорматВДеревеФормИФорматов(ФормаОтчета2005Кв1, "3.00002");

ФормаОтчета2007Кв1 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151038", '2004-01-05', "БГ-3-23/1", "ФормаОтчета2007Кв1");
ОпределитьФорматВДеревеФормИФорматов(ФормаОтчета2007Кв1, "3.00003");

ФормаОтчета2014Кв1 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151038", '2013-12-18', "ММВ-7-3/628@", "ФормаОтчета2014Кв1");
...
НоваяФорма.ОписаниеОтчета     = "Приложение к приказу МНС России от 5 января 2004 г. № БГ-3-23/1";
НоваяФорма.ДатаНачалоДействия = '2005-01-01';
НоваяФорма.ДатаКонецДействия  = '2007-02-28';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2007Кв1";
НоваяФорма.ОписаниеОтчета     = "Приложение к приказу МНС России от 5 января 2004 г. № БГ-3-23/1, с возможностью выгрузки в электронном виде в формате версии 3.00003";
