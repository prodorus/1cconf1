...
Форма20030101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1153001", '20031229', "БГ-3-21/725", "ФормаОтчета2004кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20030101, "3.00001");
...
НоваяФорма.ОписаниеОтчета     = "Утверждено Приказом МНС России от 29.12.2003 № БГ-3-21/725";
НоваяФорма.ДатаНачалоДействия = '20031230';
