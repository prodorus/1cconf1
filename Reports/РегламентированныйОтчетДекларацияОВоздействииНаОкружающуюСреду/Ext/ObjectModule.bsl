...
// Определение форм.
Форма20120101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "0000000", '20181011', "509", "ФормаОтчета2018Кв1");
...
НоваяФорма.ОписаниеОтчета     = "Форма утверждена приказом Минприроды России от 11.10.2018 № 509";
