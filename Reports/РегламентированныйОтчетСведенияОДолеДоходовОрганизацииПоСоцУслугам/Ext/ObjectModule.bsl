...
мЧтоОчищать = "Сведения";

мФормыИФорматы = РегламентированнаяОтчетность.НовоеДеревоФормИФорматов();

ФормаОтчета2015Кв4 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1150045", '2015-10-23', "ММВ-7-3/467@", "ФормаОтчета2015Кв4");
...
НоваяФорма.ОписаниеОтчета     = "Приложение № 1 к приказу ФНС России от 23.10.2015 № ММВ-7-3/467@";
