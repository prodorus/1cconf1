...
// Определение форм.
Форма20120101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "0000000", '20181107', "ЕД-4-15/21688@", "ФормаОтчета2012Кв1");
...
НоваяФорма.ОписаниеОтчета     = "Форма утверждена письмом ФНС России от 07.11.2018 № ЕД-4-15/21688@";
