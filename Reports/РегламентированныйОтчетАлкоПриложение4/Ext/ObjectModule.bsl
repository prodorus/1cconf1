...
Перем мНаименованиеОтчета Экспорт; // Название отчета. Для тех случаев, когда в одном объекте содержаться отчеты с разным названием
...
Форма20040301 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1152022", '19990525', "564", "ФормаОтчета2005Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20040301, "2.01");

Форма20060101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1152022", '20051231', "858", "ФормаОтчета2006Кв1");

Форма20060101_2 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1152022", '20051231', "858", "ФормаОтчета2006Кв2");
ОпределитьФорматВДеревеФормИФорматов(Форма20060101_2, "3.00");

Форма20060101_3 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1152022", '20051231', "858", "ФормаОтчета2006Кв3");
ОпределитьФорматВДеревеФормИФорматов(Форма20060101_3, "3.02");

Форма20091201 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1152022", '20100126', "26", "ФормаОтчета2009Кв4");
...
Форма20120701 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1152022", '2012-08-09', "815", "ФормаОтчета2012Кв3");
...
НоваяФорма.ОписаниеОтчета     = "Приложение 4 к Положению о декларировании производства и оборота этилового спирта, алкогольной и спиртосодержащей продукции (утверждено Постановлением Правительства РФ от 25.05.1999 г. №564)";
НоваяФорма.ДатаНачалоДействия = '20030101';
НоваяФорма.ДатаКонецДействия  = '20051231';
НоваяФорма.НарастающийИтог    = Истина;
НоваяФорма.НаименованиеОтчета = "Использование виноматериалов";

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2006Кв1";
НоваяФорма.ОписаниеОтчета     = "Приложение 4 к Положению о представлении декларации об объемах производства, оборота и использования этилового спирта, алкогольной и спиртосодержащей продукции (Утверждено Постановлением Правительства РФ от 31.12.2005  № 858)";
...
НоваяФорма.ОписаниеОтчета     = "Приложение 4 к Положению о представлении декларации об объемах производства, оборота и использования этилового спирта, алкогольной и спиртосодержащей продукции (Утверждено ПП РФ от 31.12.2005 № 858) (выгрузка в формате 3.02)";
НоваяФорма.ДатаНачалоДействия = '20060101';
