...
// определение форм
Форма20050101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "602002", '20050801',  "51", "ФормаОтчета2005Кв1");
Форма20070101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "602002", '20070808',  "62", "ФормаОтчета2007Кв1");
Форма20080101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "602002", '20080814', "189", "ФормаОтчета2008Кв1");
Форма20090101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "602002", '20090710', "132", "ФормаОтчета2009Кв1");
Форма20100101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "602002", '20100527', "203", "ФормаОтчета2010Кв1");
Форма20110101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "602002", '20110628', "296", "ФормаОтчета2011Кв1");
Форма20120101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "602002", '20120724', "406", "ФормаОтчета2012Кв1");
Форма20130101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "602002", '20130703', "258", "ФормаОтчета2013Кв1");
Форма20150101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "602002", '20140829', "543", "ФормаОтчета2015Кв1");
Форма20160101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "602002", '20150703', "296", "ФормаОтчета2016Кв1");
Форма20160101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "602002", '20160615', "289", "ФормаОтчета2017Кв1");
Форма20160101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "602002", '20170626', "428", "ФормаОтчета2018Кв1");
Форма20160101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "602002", '20180719', "449", "ФормаОтчета2019Кв1");
РегламентированнаяОтчетность.ОпределитьФорматВДеревеФормИФорматов(Форма20160101, "26-03-2019");
...
НоваяФорма.ОписаниеОтчета     = "Форма утверждена постановлением Росстата от 16.03.2007 № 28 (в редакции постановления Росстата от 08.08.2007 № 62)";
