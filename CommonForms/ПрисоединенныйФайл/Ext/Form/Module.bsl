...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ТекущийПользователь = ПользователиСервер.ТекущийПользователь();
	...
	Если ЗначениеЗаполнено(Параметры.ЗначениеКопирования) Тогда
		...
		ОбъектЗначение.Автор = ПользователиСервер.ТекущийПользователь();
	Иначе
...
Процедура ПроверитьПодписиНаСервере(КоллекцияСтрок)
	...
	ФайловыеФункции.ПроверитьПодписиВСтрокахКоллекции(КоллекцияСтрок);
