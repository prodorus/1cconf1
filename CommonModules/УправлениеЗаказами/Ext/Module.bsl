	...
	Если УказаниеЗаказов Тогда
		Если ВидОперации = "Реализация" Тогда
			...
			ИначеЕсли (ДокументВидОперации = Перечисления.ВидыОперацийРеализацияТоваров.ПродажаКомиссия)
			  ...
			  ИЛИ (ДокументВидОперации = Перечисления.ВидыОперацийРеализацияТоваров.ОтгрузкаБезПереходаПраваСобственности)
			  ИЛИ (ДокументВидОперации = Перечисления.ВидыОперацийРеализацияТоваров.АктВыполненныхРабот)
			  ИЛИ (ДокументВидОперации = Перечисления.ВидыОперацийРеализацияТоваров.АктНаПередачуПрав) Тогда
