...
Процедура ПоказатьВебСтраницуБраузеромПользователя(АдресСтраницы = "") Экспорт 
...
Процедура ФормаОбработкиСайт1С(Элемент, ФормаОбработки) Экспорт
	...
	ПоказатьВебСтраницуБраузеромПользователя("http://www.1c.ru");
	
КонецПроцедуры

Процедура ФормаОбработкиМониторЗаконодательства(Элемент, ФормаОбработки) Экспорт
	
	ПоказатьВебСтраницуБраузеромПользователя("http://v8.1c.ru/lawmonitor/");
	
КонецПроцедуры

Процедура ФормаОбработкиСайтБУХру(Элемент, ФормаОбработки) Экспорт
	
	ПоказатьВебСтраницуБраузеромПользователя("http://www.buh.ru/");
	
КонецПроцедуры

Процедура ФормаОбработкиСайтИТС(Элемент, ФормаОбработки) Экспорт
	
	ПоказатьВебСтраницуБраузеромПользователя("http://its.1c.ru/");
...
Процедура НачатьПоискНаИТС(СтрокаПоискаИТС) Экспорт
	...
	ПоказатьВебСтраницуБраузеромПользователя("http://its.1c.ru/db/alldb#search:" + СтрокаПоискаИТС);
