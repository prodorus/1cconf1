...
Функция ОбработчикиОбновления()
	...
	Обработчик.Процедура    = "РегламентированнаяОтчетность.НазначитьНомераПачекОтчетовПФР";
	Обработчик.Опциональный = Истина;
	
	// Версия 1.3.47.1
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.47.1";
	Обработчик.Процедура    = "РегламентированнаяОтчетность.ЗадатьДляУчетныхЗаписейИспользованиеСервисаОнлайнПроверки";
	Обработчик.Опциональный = Истина;
	
	// Версия 1.3.48.1
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.48.1";
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.48.1";
	Обработчик.Процедура    = "БиблиотекаОбновленияИнформационнойБазы.УстановитьРеквизитыДляНовогоСубчета99_09";
	Обработчик.Опциональный = Ложь;
	
	// Версия 1.3.48.1
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.48.1";
	Обработчик.Процедура    = "БиблиотекаОбновленияИнформационнойБазы.УстановитьРеквизитыДляНовыхСубчетов69_ОПС";
	Обработчик.Опциональный = Истина;
	
	// Версия 1.3.54.2
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.54.2";
	Обработчик.Процедура    = "БиблиотекаОбновленияИнформационнойБазы.ЗаполнитьРеквизитОрганизацияВПрисоединенныхФайлах";
	Обработчик.Опциональный = Истина;
	
	// Версия 1.3.58.2
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.58.2";
	Обработчик.Процедура    = "БиблиотекаОбновленияИнформационнойБазы.УстановитьРеквизитКорректироватьНДС";
	Обработчик.Опциональный = Ложь;
	
	// Версия 1.3.58.2
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.58.2";
	Обработчик.Процедура    = "БиблиотекаОбновленияИнформационнойБазы.УстановитьРеквизитКорректироватьНДСКорректировкиПоступления";
	Обработчик.Опциональный = Ложь;
	
	// Версия 1.3.60.3
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.60.3";
	Обработчик.Процедура    = "БиблиотекаОбновленияИнформационнойБазы.ЗаполнитьТабличныеЧастиВСчетахФактурахПолученных";
	Обработчик.Опциональный = Истина;
	
	// Версия 1.3.66.2
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.66.2";
	Обработчик.Процедура    = "БиблиотекаОбновленияИнформационнойБазы.УстановитьРеквизитыДляНовогоСчетаТорговыйСбор";
	Обработчик.Опциональный = Истина;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.66.2";
	Обработчик.Процедура    = "БиблиотекаОбновленияИнформационнойБазы.ЗаполнитьСпособПогашенияСпецодеждыСпецоснастки";
	Обработчик.Опциональный = Истина;
	
	// Версия 1.3.79.1
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.79.1";
	Обработчик.Процедура    = "БиблиотекаОбновленияИнформационнойБазы.ИсправитьНекорректныеСостоянияОтправок2НДФЛ";
	Обработчик.Опциональный = Истина; // Для пустой базы не должно выполняться.
	
	// Версия 1.3.91.2
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.91.2";
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.91.2";
	Обработчик.Процедура    = "РегистрыСведений.СтавкиНалогаНаИмуществоПоОтдельнымОсновнымСредствам.ЗаполнитьКадастровыйУсловныйНомер";
	Обработчик.Опциональный = Истина;
	
	// Версия 1.3.92.1
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.92.1";
	Обработчик.Процедура    = "Справочники.ТорговоеОборудование.ЗаполнитьСпособФЛК";
	Обработчик.Опциональный = Ложь;
	
	// Версия 1.3.92.3
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.92.3";
	Обработчик.Процедура    = "РегламентированнаяОтчетность.ОтключитьОбменНапрямуюДляРПН";
	Обработчик.Опциональный = Истина;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.93.2";
	Обработчик.Процедура    = "БиблиотекаОбновленияИнформационнойБазы.ЗаполнитьСправочникВидыКонтактнойИнформации";
	Обработчик.Опциональный = Истина;
		
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.95.1";
	Обработчик.Процедура    = "ПроцедурыОбновленияИнформационнойБазы.ПроставитьФлажокОплатыТруда";
	Обработчик.Опциональный = Истина;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.96.1";
	...
	Обработчик.Процедура    = "БиблиотекаОбновленияИнформационнойБазы.ЗаполнитьКодТНВЭД_ВозратТоваровПоставщику";
	Обработчик.Опциональный = Истина;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.98.1";
	Обработчик.Процедура    = "БиблиотекаОбновленияИнформационнойБазы.ЗаполнитьКодТНВЭД_КорректировкаРеализации";
	Обработчик.Опциональный = Истина;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.98.1";
	Обработчик.Процедура    = "БиблиотекаОбновленияИнформационнойБазы.ЗаполнитьКодТНВЭД_ОтчетКомиссионераОПродажах";
	Обработчик.Опциональный = Истина;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.98.1";
	Обработчик.Процедура    = "БиблиотекаОбновленияИнформационнойБазы.ЗаполнитьКодТНВЭД_РеализацияТоваровИУслуг";
	Обработчик.Опциональный = Истина;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.98.1";
	Обработчик.Процедура    = "Справочники.НомераГТД.ОпределитьРегистрационныйНомерИСтрануВвоза";
	Обработчик.Опциональный = Истина;
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.103.1";
	Обработчик.Процедура    = "ПроцедурыОбновленияИнформационнойБазы.УстановитьДатуНачалаОперацийСТоварамиОблагаемымиНДСУПокупателя";
	Обработчик.Опциональный = Истина;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.106.1";
	Обработчик.Процедура    = "Справочники.ЭДПрисоединенныеФайлы.ПерезаполнитьДокументыОснования";
	Обработчик.Опциональный = Истина;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.106.2";
	Обработчик.Процедура    = "Документы.УведомлениеОКонтролируемыхСделках.УстановитьВерсиюУведомленияОКонтролируемыхСделках";
	Обработчик.Опциональный = Истина;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.106.2";
	Обработчик.Процедура    = "Документы.ЭлектронныйДокументВходящий.СвернутьДокументыОснования";
	Обработчик.Опциональный = Истина;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.106.2";
	Обработчик.Процедура    = "Документы.ЭлектронныйДокументИсходящий.СвернутьДокументыОснования";
	Обработчик.Опциональный = Истина;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.112.1";
	Обработчик.Процедура    = "РегламентированнаяОтчетность.ЗаменитьВОрганизацияхИПодразделенияхКодОрганаФСГС";
	Обработчик.Опциональный = Истина;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.114.1";
	Обработчик.Процедура    = "РегламентированнаяОтчетность.ПереносОтправокМинобороны";
	Обработчик.Опциональный = Истина;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.115.1";
	Обработчик.Процедура    = "КонтролируемыеСделки.ЗаполнитьГраницыКонтролируемости";
	Обработчик.Опциональный = Истина;
	
	// Версия 1.1.121.1
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия       = "1.3.121.2";
...
Процедура ПервыйЗапуск() Экспорт
	...
	//275-ФЗ
	ОбщегоНазначения275Сервер.ПервыйЗапуск();
...
// Устанавливается код быстрого выбора для нового счета 69.06 и его субсчетов
//
Процедура УстановитьРеквизитыДляНовыхСубчетов69_ОПС() Экспорт
	
	ЗаполнитьКодыБыстрогоВыбораПлановСчетов();
	Документы.УстановкаСоответствияСчетовБУиНУ.СоздатьНовыеСоответствияСчетовБУиНУ("ДляСубсчетов69_ОПС");
...
// Устанавливается код быстрого выбора для нового счета 99.09
//
Процедура УстановитьРеквизитыДляНовогоСубчета99_09() Экспорт
	
    СчетОбъект = ПланыСчетов.Хозрасчетный.ПрочиеПрибылиИУбытки.ПолучитьОбъект();
    СчетОбъект.КодБыстрогоВыбора = "9909";
    Попытка
        СчетОбъект.Записать();
	Исключение
        ОбщегоНазначения.СообщитьОбОшибке("Не удалось установить код быстрого доступа для счета 99.09, рекомендуется установить самостоятельно");
    КонецПопытки;
...
// Заполнение реквизита "Организация" справочника "Присоединенные файлы (Электронные документы)"
// для элементов с реквизитом "Вид ЭД" = "Дополнительные данные"
//
Процедура ЗаполнитьРеквизитОрганизацияВПрисоединенныхФайлах() Экспорт
	Запрос = Новый Запрос();
	Запрос.Текст =
	"ВЫБРАТЬ
	|	ЭДПрисоединенныеФайлы.Ссылка,
	|	ЭДПрисоединенныеФайлы.ЭлектронныйДокументВладелец.Организация КАК ОрганизацияВладельца
	|ИЗ
	|	Справочник.ЭДПрисоединенныеФайлы КАК ЭДПрисоединенныеФайлы
	|ГДЕ
	|	ЭДПрисоединенныеФайлы.ВидЭД = ЗНАЧЕНИЕ(Перечисление.ВидыЭД.ДопДанные)
	|	И ЭДПрисоединенныеФайлы.Организация = ЗНАЧЕНИЕ(Справочник.Организации.ПустаяСсылка)
	|	И НЕ ЭДПрисоединенныеФайлы.ЭлектронныйДокументВладелец = ЗНАЧЕНИЕ(Справочник.ЭДПрисоединенныеФайлы.ПустаяСсылка)
	|	И НЕ ЭДПрисоединенныеФайлы.ЭлектронныйДокументВладелец.Организация = ЗНАЧЕНИЕ(Справочник.Организации.ПустаяСсылка)";
	Выборка = Запрос.Выполнить().Выбрать();
	Пока Выборка.Следующий() Цикл
		текОбъект = Выборка.Ссылка.ПолучитьОбъект();
		текОбъект.Организация = Выборка.ОрганизацияВладельца;
...
Процедура УстановитьРеквизитКорректироватьНДСКорректировкиПоступления() Экспорт
...
Процедура ЗаполнитьТабличныеЧастиВСчетахФактурахПолученных() Экспорт
	...
	// Заполнение ТЧ Продавцы
	
	Запрос = Новый Запрос;
	Запрос.Текст =
	"ВЫБРАТЬ
	|	СчетФактураПолученный.Ссылка КАК Ссылка,
	|	СчетФактураПолученный.Продавец КАК Продавец
	|ИЗ
	|	Документ.СчетФактураПолученный КАК СчетФактураПолученный
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.СчетФактураПолученный.Продавцы КАК Продавцы1
	|		ПО СчетФактураПолученный.Ссылка = Продавцы1.Ссылка
	|ГДЕ
	|	СчетФактураПолученный.Продавец <> ЗНАЧЕНИЕ(Справочник.Контрагенты.ПустаяСсылка)
	|	И Продавцы1.Ссылка ЕСТЬ NULL";
...
Процедура УстановитьРеквизитыДляНовогоСчетаТорговыйСбор() Экспорт

	Счет = ПланыСчетов.Хозрасчетный.ТорговыйСбор;
	ДанныеСчета = ОбщегоНазначения.ПолучитьЗначенияРеквизитов(Счет, "КодБыстрогоВыбора");
	Если НЕ ЗначениеЗаполнено(ДанныеСчета.КодБыстрогоВыбора) Тогда
		ОбъектСчет = Счет.ПолучитьОбъект();
		ОбъектСчет.КодБыстрогоВыбора = "6813";
		Попытка
			ОбъектСчет.Записать();
		Исключение
			ТекстСообщения = ПодробноеПредставлениеОшибки(ИнформацияОбОшибке());
...
Процедура ЗаполнитьСпособПогашенияСпецодеждыСпецоснастки() Экспорт
	...
	|ГДЕ
	|	УчетнаяПолитикаОрганизаций.СпособПогашенияСтоимостиСпецодеждыНУ = ЗНАЧЕНИЕ(Перечисление.СпособыПогашенияСтоимостиНУ.ПустаяСсылка)";
	...
	Пока Выборка.Следующий() Цикл
		...
		Если МенеджерЗаписи.Выбран() Тогда
			МенеджерЗаписи.СпособПогашенияСтоимостиСпецодеждыНУ = Перечисления.СпособыПогашенияСтоимостиНУ.ПриПередачеВЭксплуатацию;
			Попытка
...
Процедура ИсправитьНекорректныеСостоянияОтправок2НДФЛ() Экспорт
	...
	Запрос.Текст = 
		...
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.СтатусыОтправки КАК СтатусыОтправки
		|		ПО ТранспортноеСообщение.ЦиклОбмена.Предмет = СтатусыОтправки.Объект
		|ГДЕ
		|	ТранспортноеСообщение.ПротоколСОшибкой = ЛОЖЬ
		|	И ТранспортноеСообщение.Тип = &Тип
		|	И СтатусыОтправки.Статус <> ЗНАЧЕНИЕ(Перечисление.СтатусыОтправки.ПринятЕстьОшибки)";
...
Процедура УстановитьКорректноеЗначениеОшибкиПротокола2НДФЛ(Строка)
	...
	Если Протокол2НДФЛЯвляетсяОтрицательным(ТранспортноеСообщение) <> Ложь Тогда
...
Процедура ОбновитьСтатусыСвязанногоОбъектаПриНеобходимости(Объект, СтрогоПоДанномуЦиклуОбмена = Ложь)
...
Процедура ЗаписатьСтатусОтправкиОбъекта(докСсылка, Статус)
	
	Если НЕ Метаданные.РегистрыСведений.СтатусыОтправки.Измерения.Объект.Тип.СодержитТип(ТипЗнч(докСсылка)) Тогда
		Возврат;
	КонецЕсли;
...
Функция РассчитатьСтатусОтправкиОбъекта(Объект, Знач ЦиклОбмена = Неопределено)
...
Функция ПолучитьПредметыЦиклаОбмена(ЦиклОбмена)
...
Функция ПолучитьПоследнийЦиклОбмена(Объект)
	...
	ТипМассивПервичное.Добавить(Перечисления.ТипыЦикловОбмена.ЗапросНаВыпискуИзЕГРЮЛ_ЕГРИП);
...
Функция ПолучитьСообщенияЦиклаОбмена(ЦиклОбмена, ТипыСообщений = Неопределено, ПомеченныеНаУдаление = Ложь, ТолькоЗавершенные = Ложь)
...
Функция РассчитатьСтатусЦиклаОбмена(ЦиклОбмена)
...
Функция Протокол2НДФЛЯвляетсяОтрицательным(Объект)
	...
	ЕстьФайлНеПринят = Найти(ТекстПротокола, "ФАЙЛ НЕ ПРИНЯТ") > 0;
...
Функция ПолучитьВложенияТранспортногоСообщения(ТранспортноеСообщение, СДанными = Ложь, ФильтрПоТипу = Неопределено, ИмяФайла = Неопределено)
...
Функция Отчет2НДФЛСданЧастично(Объект) Экспорт
	...
	КоличествоПринятыхСведений1 = КоличествоСведенийВПротоколе2НДФЛ(ТекстПротокола, ВидСведений);
	
	ВидСведений = "КОЛИЧЕСТВО СВЕДЕНИЙ, ГОТОВЫХ К ПРИЕМУ:"; // с 2019 г.
	КоличествоПринятыхСведений2 = КоличествоСведенийВПротоколе2НДФЛ(ТекстПротокола, ВидСведений);
	
	КоличествоПринятыхСведений = Макс(КоличествоПринятыхСведений1, КоличествоПринятыхСведений2);
...
Процедура ИсправитьНекорректныеСостоянияОтправок2НДФЛ_2() Экспорт
	...
	Запрос.Текст = 
		...
		|		ПО ТранспортноеСообщение.ЦиклОбмена.Предмет = СтатусыОтправки.Объект
		|ГДЕ
		|	ТранспортноеСообщение.ПротоколСОшибкой = Истина
		|	И ТранспортноеСообщение.Тип = Значение(Перечисление.ТипыТранспортныхСообщений.РезультатПриемаФорма2НДФЛНО)
		|	И СтатусыОтправки.Статус = ЗНАЧЕНИЕ(Перечисление.СтатусыОтправки.ПринятЕстьОшибки)";
	...
	Для каждого Строка Из Сообщения Цикл
	    УстановитьКорректноеЗначениеПротоколСОшибкойПротокола2НДФЛ(Строка);
	КонецЦикла;
...
Процедура УстановитьКорректноеЗначениеПротоколСОшибкойПротокола2НДФЛ(Строка)
	
	ТранспортноеСообщение = Строка.ТранспортноеСообщение;
	
	Если Отчет2НДФЛСданЧастично(ТранспортноеСообщение) = Ложь Тогда

		ТранспортноеСообщениеОбъект = ТранспортноеСообщение.ПолучитьОбъект();
		ТранспортноеСообщениеОбъект.ПротоколСОшибкой = Ложь;
		ТранспортноеСообщениеОбъект.Записать();
