	...
	Иначе
		Если ТипЦен <> Неопределено Тогда
			Если Контрагент = Неопределено Тогда
				Цена = Ценообразование.ПолучитьЦенуНоменклатуры(Номенклатура, Характеристика, ТипЦен, 
					ДатаЦен, Единица, Валюта, , , , Договор, УсловиеПродаж);
			Иначе
				Цена = Ценообразование.ПолучитьЦенуКонтрагента(Номенклатура, Характеристика, Контрагент, ТипЦен, 
					ДатаЦен, Единица, Валюта, , , Договор, УсловиеПродаж);
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
...
//
// Возвращаемое значение:
//  Булево - Истина, если эквайринговая система и фискальное устройство выбраны.
//
