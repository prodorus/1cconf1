...
Функция ТекстОписанияРасчетногоДокумента() Экспорт
...
КонецФункции // ТекстОписанияРасчетногоДокумента()

Функция ВернутьТекстВТНачислениеКомандировки() Экспорт
...
Функция НеобходимоСоздатьРасчетныйДокументПоНеявке(ТипРасчетногоДокумента, ВидНеявки, СтрокаТаблицы) Экспорт
	
	Возврат Ложь;
	
КонецФункции

Функция СоздатьРасчетныйДокументПоНеявке(ТипРасчетногоДокумента, ВидНеявки, СтрокаТаблицы, ГоловнаяОрганизация, ПериодРегистрации, СтрокаСообщенияОбОшибке, РасчетныйДокументДляИсправления, ДанныеОтпусков) Экспорт
...
Функция ПолучитьРассчитываемыеТаблицыПоТипуДокумента(ТипРасчетногоДокумента) Экспорт
	
	Возврат Новый Структура("Начисления, РасчетСреднего", Истина, Истина);
