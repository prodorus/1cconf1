...
Процедура ОбработкаРасшифровкиОтчета(ФормаОтчета, Элемент, Расшифровка, СтандартнаяОбработка) Экспорт
	...
	Если СтруктураРасшифровки.Свойство("ДокументОснование") И СтруктураРасшифровки.ДокументОснование = Неопределено Тогда
		...
		ПоказатьПредупреждениеЕГАИС(, НСтр("ru='В базе данных отсутствует документ-основание.'"));
		Возврат;
	КонецЕсли;
	...
	Если СтруктураРасшифровки.Свойство("ИдентификаторЕГАИС") И ЗначениеЗаполнено(СтруктураРасшифровки.ИдентификаторЕГАИС) Тогда
		...
		НачатьФормированиеЗапросаТТН(ФормаОтчета, СтруктураРасшифровки.ОрганизацияЕГАИС, СтруктураРасшифровки.ИдентификаторЕГАИС);
	...
	ИначеЕсли СтруктураРасшифровки.Свойство("КодГрузоотправителя") И ЗначениеЗаполнено(СтруктураРасшифровки.КодГрузоотправителя) Тогда
		...
		НачатьФормированиеЗапросаОрганизаций(ФормаОтчета, СтруктураРасшифровки.ОрганизацияЕГАИС, СтруктураРасшифровки.КодГрузоотправителя);
	...
	ИначеЕсли СтруктураРасшифровки.Свойство("КодАлкогольнойПродукции") И ЗначениеЗаполнено(СтруктураРасшифровки.КодАлкогольнойПродукции) Тогда
		...
		НачатьФормированиеЗапросаАлкогольнойПродукции(ФормаОтчета, СтруктураРасшифровки.ОрганизацияЕГАИС, СтруктураРасшифровки.КодАлкогольнойПродукции);
	...
	ИначеЕсли СтруктураРасшифровки.Свойство("Справка2") Тогда
		...
		Если НЕ ПустаяСтрока(НомерСправки2) Тогда
			НачатьФормированиеЗапросаСправки2(ФормаОтчета, СтруктураРасшифровки.ОрганизацияЕГАИС, НомерСправки2);
		КонецЕсли;
...
Процедура НачатьФормированиеЗапросаТТН(ФормаОтчета, ОрганизацияЕГАИС, ИдентификаторЕГАИС)
...
Процедура НачатьФормированиеЗапросаОрганизаций(ФормаОтчета, ОрганизацияЕГАИС, КодФСРАР)
...
Процедура НачатьФормированиеЗапросаАлкогольнойПродукции(ФормаОтчета, ОрганизацияЕГАИС, КодАлкогольнойПродукции)
...
Процедура НачатьФормированиеЗапросаСправки2(ФормаОтчета, ОрганизацияЕГАИС, НомерСправки2)
