...
Функция НайтиРезюмеКандидата(ЗаявкаКандидата, ТиповаяАнкета = Неопределено) Экспорт
	...
	Возврат АнкетированиеДополнительный.НайтиРезюмеКандидата(ЗаявкаКандидата, ТиповаяАнкета);
...
Функция СписокДоговоровФормыВыбораСотрудника(Режим) Экспорт
...
КонецФункции // СписокДоговоровФормыВыбораСотрудника
...
Процедура ОткрытьФормуВыбораСотрудника(Владелец, Ключ, ЗакрыватьПриВыборе, ДатаСреза, СтандартнаяОбработка = Неопределено, ТекущееЗначение = Неопределено, ВыборФизлица = Ложь, ПараметрыПодбора = Неопределено, Подразделение = Неопределено, ПараметрыОтбора = Неопределено) Экспорт
