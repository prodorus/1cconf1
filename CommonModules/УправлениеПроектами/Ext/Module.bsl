...
Процедура ЗаполнитьПроект(Приемник, Источник, ИмяРеквизитаПроектВИсточнике = "Проект") Экспорт
	Попытка 
		ЗначениеЗаполнения = Источник[ИмяРеквизитаПроектВИсточнике];
		Если ЗначениеЗаполнено(ЗначениеЗаполнения) И Не ЗначениеЗаполнено(Приемник.Проект) Тогда
			Приемник.Проект = ЗначениеЗаполнения;
		КонецЕсли;
	Исключение
	КонецПопытки;
КонецПроцедуры
