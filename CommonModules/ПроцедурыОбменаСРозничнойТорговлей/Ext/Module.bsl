...
Процедура ДополнитьМассивУзловДляВыгрузкиДокумента(Элемент, МассивУзловДляПередачи, 
	...
	Иначе
		...
		Если ТипЭлемента = Тип("ДокументСсылка.ОтчетОРозничныхПродажах")
			...
			ИЛИ ТипЭлемента = Тип("ДокументОбъект.РасходныйОрдерНаТовары")
			ИЛИ ТипЭлемента = Тип("ДокументСсылка.ТТНВходящаяЕГАИС")
			ИЛИ ТипЭлемента = Тип("ДокументОбъект.ТТНВходящаяЕГАИС") Тогда
			
			МассивУзловСкладов = Новый Массив;
			ДополнитьМассивУзламиПоСкладу(МассивУзловСкладов, ?(ТипЭлемента = Тип("ДокументСсылка.ТТНВходящаяЕГАИС") ИЛИ ТипЭлемента = Тип("ДокументОбъект.ТТНВходящаяЕГАИС"), Элемент.ТорговыйОбъект, Элемент.Склад), 
