...
Процедура ДвижениеПоРегиструУчетЗатратПогашениеСтоимости(
	...
	Если СтруктураСуммНУ <> Неопределено Тогда
		СтоимостьНУ = СтруктураСуммНУ.ПогашеннаяСтоимостьНУ;
		ПостояннаяРазница = СтруктураСуммНУ.ПогашеннаяСтоимостьПР;
	Иначе
		СтоимостьНУ = 0;
	КонецЕсли;
...
//	СтруктураКлючиАналитики - Структура - Структура с таблицами ключей аналитики для кэширования данных
//	СтруктураНаборыЗаписей - Структура - Структура наборов записей регистров
//	СтруктураСуммНУ - структура сумм движений по НУ
//
Процедура ДвижениеПоРегиструУчетЗатратМатериалыВЭксплуатации(
	...
	ПогашатьСтоимостьВНУКакВБУ = СтруктураШапкиДокумента.Свойство("ПогашатьСтоимостьВНУКакВБУ")
				...
				И СтруктураСуммНУ <> Неопределено;
	...
	Если ПогашатьСтоимостьВНУКакВБУ Тогда
		...
		Если ПогашеннаяСтоимость <> 0 ИЛИ СтруктураСуммНУ.ПогашеннаяСтоимостьНУ <> 0 ИЛИ СтруктураСуммНУ.ПогашеннаяСтоимостьПР <> 0 Тогда
			...
			СформироватьДвиженияПоРегиструУчетЗатрат(
				...
				ПогашеннаяСтоимость,
				0, // Количество,
				СтруктураСуммНУ.ПогашеннаяСтоимостьНУ, // СтоимостьНУ,
				СтруктураСуммНУ.ПогашеннаяСтоимостьПР, // ПостояннаяРазница,
				СтруктураНаборыЗаписей[ИмяРегистра]
			);
			...
			Если МассивФиксСтоимость.Найти(СтрокаВыборки.КодОперации) <> Неопределено Тогда
				...
				СформироватьДвиженияПоРегиструУчетЗатрат(
					...
					КорректировкаСтоимостиСписания,
					0, // Количество,
					СтруктураСуммНУ.КорректировкаСтоимостиСписанияНУ, // СтоимостьНУ,
					СтруктураСуммНУ.КорректировкаСтоимостиСписанияПР, // ПостояннаяРазница,
					СтруктураНаборыЗаписей[ИмяРегистра]
				);
