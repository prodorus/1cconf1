...
Процедура ПоказатьПредупреждениеБезопасности() Экспорт
	ФормаПредупреждениеБезопасности = ПолучитьФорму("ОбщаяФорма.ПредупреждениеБезопасности");
	ФормаПредупреждениеБезопасности.Элементы.КнопкаОтменить.Видимость = Ложь;
	ФормаПредупреждениеБезопасности.Элементы.КнопкаПродолжить.Заголовок = "Закрыть";
	ФормаПредупреждениеБезопасности.Элементы.СтраницыПредупреждений.ТекущаяСтраница =
		ФормаПредупреждениеБезопасности.Элементы.Страница4;
	ОткрытьФорму(ФормаПредупреждениеБезопасности);
КонецПроцедуры
