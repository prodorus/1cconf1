...
Процедура СформироватьДвиженияПоДоходам(ДокументОбъект, ВыборкаПоШапкеДокумента, Заголовок, Отказ, НаборЗаписей = Неопределено) Экспорт
	...
	|	Основные.ЛьготныйТерриториальныйТариф,
	...
	|	Дополнительные.ЛьготныйТерриториальныйТариф,
	...
	|	Пособия.ЛьготныйТерриториальныйТариф,
	...
	|	ПособияПоУходу.ЛьготныйТерриториальныйТариф,
...
Процедура Автозаполнение(ДокументОбъект, ВыборкаПоШапкеДокумента, ОграничениеНаСотрудников, Отказ, УчитыватьСуществующиеДанные = Истина) Экспорт
	...
	Если ДокументОбъект.ПериодРегистрации < '20180101' Тогда
		АвтозаполнениеДо2018(ДокументОбъект, ВыборкаПоШапкеДокумента, ОграничениеНаСотрудников, Отказ, УчитыватьСуществующиеДанные);
		Возврат;
	КонецЕсли;
	...
	Иначе
		...
		|		КОНЕЦ, ЗНАЧЕНИЕ(Перечисление.ТарифыСтраховыхВзносов.ПустаяСсылка)) КАК ЛьготныйТерриториальныйТариф,
		|	ЕСТЬNULL(ВЫБОР
		|			КОГДА Работники.ПериодЗавершения <= СтрокиРегистра.ДатаАктуальности
		|					И Работники.ПериодЗавершения <> ДАТАВРЕМЯ(1, 1, 1, 0, 0, 0)
		...
		ДокументОбъект.ОсновныеНачисления.ЗагрузитьКолонку(ВременнаяТЗ.ВыгрузитьКолонку("ЛьготныйТерриториальныйТариф"),"ЛьготныйТерриториальныйТариф");
		...
		ТаблицаДополнительныеНачисления.Колонки.Добавить("ЛьготныйТерриториальныйТариф",Новый ОписаниеТипов("ПеречислениеСсылка.ТарифыСтраховыхВзносов"));
		Номер = 0;
		...
		ТаблицаДополнительныеНачисления.ЗагрузитьКолонку(ВременнаяТЗ.ВыгрузитьКолонку("ЛьготныйТерриториальныйТариф"),"ЛьготныйТерриториальныйТариф");
		ВременнаяТЗ = Неопределено;
		...
		ДокументОбъект.ПособияПоСоциальномуСтрахованию.ЗагрузитьКолонку(ВременнаяТЗ.ВыгрузитьКолонку("ЛьготныйТерриториальныйТариф"),"ЛьготныйТерриториальныйТариф");
		ВременнаяТЗ = Неопределено;
		...
		ДокументОбъект.ПособияПоУходуЗаРебенкомДоПолутораЛет.ЗагрузитьКолонку(ВременнаяТЗ.ВыгрузитьКолонку("ЛьготныйТерриториальныйТариф"),"ЛьготныйТерриториальныйТариф");
		ВременнаяТЗ = Неопределено;
...
Процедура АвтозаполнениеДо2018(ДокументОбъект, ВыборкаПоШапкеДокумента, ОграничениеНаСотрудников, Отказ, УчитыватьСуществующиеДанные = Истина) Экспорт
