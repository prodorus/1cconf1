...
Процедура ВыполнитьДополнительныеПроверки(Отказ, Форма) Экспорт
...
Процедура ЗаполнитьТаблицуПоказателей(ВидПВР, Переменные, ГенераторСлучайныхЧисел) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Если ЗначениеЗаполнено(Идентификатор) Тогда
			...
			Переменные.Вставить(Идентификатор, ЧислоДляИдентификатора);
		КонецЕсли;
...
Процедура ДополнитьТипыПоказателейСОграничениемВида(ТипыПоказателей) Экспорт
	
	УправлениеПоказателямиСхемМотивации.ДополнитьТипыПоказателейСОграничениемВида(ТипыПоказателей);
	
КонецПроцедуры // ДополнитьТипыПоказателейСОграничениемВида

Процедура ДополнитьТипыПоказателейСОграничениемВозможностиИзменения(ТипыПоказателей) Экспорт
	
	УправлениеПоказателямиСхемМотивации.ДополнитьТипыПоказателейСОграничениемВозможностиИзменения(ТипыПоказателей);
	
КонецПроцедуры // ДополнитьТипыПоказателейСОграничениемВозможностиИзменения

Процедура ДополнитьПоказателиУчетаВремени(МассивПоказателей) Экспорт
	
	УправлениеПоказателямиСхемМотивации.ДополнитьПоказателиУчетаВремени(МассивПоказателей);
	
КонецПроцедуры // ДополнитьПоказателиУчетаВремени
	
Процедура ДополнитьПоказателиНачисляетсяВЦеломЗаМесяц(МассивПоказателей) Экспорт
	
	УправлениеПоказателямиСхемМотивации.ДополнитьПоказателиНачисляетсяВЦеломЗаМесяц(МассивПоказателей);
	
КонецПроцедуры // ДополнитьПоказателиНачисляетсяВЦеломЗаМесяц
	
Процедура ДополнитьТипыПоказателейУчетаВремени(МассивПоказателей) Экспорт
	
	УправлениеПоказателямиСхемМотивации.ДополнитьТипыПоказателейУчетаВремени(МассивПоказателей);
	
КонецПроцедуры // ДополнитьТипыПоказателейУчетаВремени
