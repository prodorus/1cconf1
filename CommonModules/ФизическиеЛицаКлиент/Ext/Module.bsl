...
Функция ОписаниеВидаЗастрахованногоЛица(ВидЗастрахованногоЛица, Краткое = Истина) Экспорт 
	...
	Если ВидЗастрахованногоЛица = Перечисления.ВидыЗастрахованныхЛицОбязательногоСтрахования.ГражданеРФ Или Не ЗначениеЗаполнено(ВидЗастрахованногоЛица) Тогда
		Описание = ?(Краткое,"имеет право на пенсионное, медицинское и социальное страхование",
		"На граждан России распространяется обязательное пенсионное, медицинское и социальное страхование в полном объеме.");
	ИначеЕсли ВидЗастрахованногоЛица = Перечисления.ВидыЗастрахованныхЛицОбязательногоСтрахования.ПостоянноПроживающиеИностранцы Тогда
		Описание = ?(Краткое,"имеет право на пенсионное, медицинское и социальное страхование",
		"На приравненных к гражданам РФ иностранных граждан и лиц без гражданства распространяется обязательное пенсионное, медицинское и социальное страхование в полном объеме. Страховые взносы уплачиваются в общеустановленном порядке.");
	ИначеЕсли ВидЗастрахованногоЛица = Перечисления.ВидыЗастрахованныхЛицОбязательногоСтрахования.ВысококвалифицированныеСпециалистыПостоянноПроживающие Тогда
		Описание = ?(Краткое,"имеет право на пенсионное и социальное страхование",
		"На постоянно проживающих на территории РФ иностранных граждан и лиц без гражданства, являющихся высококвалифицированными специалистами и членами их семей, распространяется обязательное пенсионное и социальное страхование в полном объеме. Страховые взносы в ПФР и ФСС уплачиваются в том же порядке, что и за граждан РФ");
	ИначеЕсли ВидЗастрахованногоЛица = Перечисления.ВидыЗастрахованныхЛицОбязательногоСтрахования.ВременноПроживающиеИностранцы Тогда
		Описание = ?(Краткое,"имеет право на пенсионное, медицинское и социальное страхование",
		"На временно проживающих на территории РФ иностранных граждан и лиц без гражданства распространяется обязательное медицинское и социальное страхование в полном объеме. В части пенсионного страхования все уплачиваемые за временно проживающих взносы с 2012 года относятся к страховой части пенсии.");
	ИначеЕсли ВидЗастрахованногоЛица = Перечисления.ВидыЗастрахованныхЛицОбязательногоСтрахования.ВысококвалифицированныеСпециалистыВременноПроживающие Тогда
		Описание = ?(Краткое,"имеет право на пенсионное и социальное страхование",
		"На временно проживающих на территории РФ иностранных граждан и лиц без гражданства, являющихся высококвалифицированными специалистами и членами их семей, распространяется обязательное пенсионное и социальное страхование в полном объеме. В части пенсионного страхования все уплачиваемые взносы с 2012 года относятся к страховой части пенсии.");
	ИначеЕсли ВидЗастрахованногоЛица = Перечисления.ВидыЗастрахованныхЛицОбязательногоСтрахования.ВременноПребывающиеИностранцы Тогда
		Описание = ?(Краткое,"с 1 января 2015 года имеет право на пенсионное и социальное страхование",
		"На временно пребывающих на территории РФ иностранных граждан и лиц без гражданства не распространяется медицинское страхование в РФ. Обязательное социальное и пенсионное страхование распространяется на таких лиц с 1 января 2015 года, с 1 января 2012 года по 31 декабря 2014 года право на пенсионное страхование распространяется при условии заключения трудового договора на срок не менее 6 месяцев.");
	ИначеЕсли ВидЗастрахованногоЛица = Перечисления.ВидыЗастрахованныхЛицОбязательногоСтрахования.ВременноПребывающиеИностранцыПризнанныеБеженцами Тогда
		Описание = ?(Краткое,"имеет право на пенсионное, медицинское и социальное страхование",
		"На временно пребывающих на территории РФ иностранных граждан и лиц без гражданства, получивших временное убежище на территории РФ или свидетельство о рассмотрении ходатайства о признании беженцем, распространяется обязательное медицинское страхование в РФ. Обязательное социальное и пенсионное страхование распространяется на таких лиц с 1 января 2015 года, с 1 января 2012 года по 31 декабря 2014 года право на пенсионное страхование распространяется при условии заключения трудового договора на срок не менее 6 месяцев.");
	ИначеЕсли ВидЗастрахованногоЛица = Перечисления.ВидыЗастрахованныхЛицОбязательногоСтрахования.ВременноПребывающиеИностранцыНестрахуемые Тогда
		Описание = ?(Краткое,"не имеет права на обязательное страхование",
		"На нестрахуемых временно пребывающих на территории РФ иностранных граждан и лиц без гражданства (в том числе высококвалифицированных иностранных специалистов) не распространяется пенсионное, медицинское и социальное страхование в РФ.");
	ИначеЕсли ВидЗастрахованногоЛица = Перечисления.ВидыЗастрахованныхЛицОбязательногоСтрахования.ВременноПребывающиеИностранцыСтрахуемыеФСС Тогда
		Описание = ?(Краткое,"с 1 января 2015 года имеет право на социальное страхование",
		"На временно пребывающих на территории РФ иностранных граждан стран, с которыми заключены соответствующие международные договоры, не распространяется медицинское страхование и пенсионное страхование в РФ. Обязательное социальное распространяется на таких лиц с 1 января 2015 года.");
	ИначеЕсли ВидЗастрахованногоЛица = Перечисления.ВидыЗастрахованныхЛицОбязательногоСтрахования.ВысококвалифицированныеСпециалистыИзЕАЭС Тогда
		Описание = ?(Краткое,"с 1 января 2015 года имеет право на медицинское и социальное страхование",
		"На временно пребывающих на территории РФ граждан стран ЕАЭС, являющихся высококвалифицированными специалистами и членами их семей, с 1 января 2015 года распространяется обязательное медицинское и социальное страхование в полном объеме.");
	КонецЕсли;
...
Процедура ОбновитьПредставлениеЭлемента(ИмяОбновляемогоЭлемента, ЭтаФорма, Параметр = Неопределено)
	...
	Если ИмяОбновляемогоЭлемента = "Гражданство" Тогда
		...
		Если мНаборЗаписейГражданство.Количество() > 0 Тогда
			...
			ЭтаФорма.Гражданство = "" + мНаборЗаписейГражданство[0].Страна + ", " + ОписаниеВидаЗастрахованногоЛица(мНаборЗаписейГражданство[0].ВидЗастрахованногоЛица);
			ЭтаФорма.Модифицированность = Истина;
			
		Иначе
			// в регистре сведений нет записей, покажем значение по умолчанию
			ЭтаФорма.Гражданство = "РОССИЯ, имеет право на пенсионное, медицинское и социальное страхование";
		...
		Если мНаборЗаписейВоинскийУчет.Количество() > 0 Тогда
			...
			Иначе
				ЭтаФорма.ВоинскийУчет 	= "" + СтруктураВоинскийУчет.ОтношениеКВоинскойОбязанности
										...
										+ ?(ЗначениеЗаполнено(СтруктураВоинскийУчет.ЗабронированОрганизацией),", " + ОбщегоНазначенияЗК.ПреобразоватьСтрокуИнтерфейса("Забронирован за организацией") + " " + Строка(СтруктураВоинскийУчет.ЗабронированОрганизацией),"")
...
// 
Процедура ПроверитьДублиФизическихЛиц(Отказ, ОбработкаКомментариев, ФизлицоСсылка, ИНН, СтраховойНомерПФР, ФИО, ДокументУдостоверяющийЛичность = Неопределено) Экспорт
...
Процедура ОбработатьИзменениеПериодСтатусаНалогоплательщикаПоНДФЛ(ЭтаФорма) Экспорт
	...
	Если ЗначениеЗаполнено(ДатаОкончания) Тогда
		...
		НадписьОкончанияДействия = "по " + Формат(ДатаОкончания, "ДЛФ=DD");
	Иначе
...
Функция ПолучитьОписаниеСтатусаНалогоплательщикаПоНДФЛ(СтатусНалогоплательщикаПоНДФЛ) Экспорт
	...
	ИначеЕсли  СтатусНалогоплательщикаПоНДФЛ = Перечисления.СтатусыНалогоплательщиковПоНДФЛ.ВысококвалифицированныйИностранныйСпециалист Тогда
		ТекстОписания = "Физическое лицо - нерезидент является высококвалифицированным иностранным специалистом." + Символы.ПС + "При исчислении НДФЛ с оплаты труда будет применяться ставка 13%";
	ИначеЕсли  СтатусНалогоплательщикаПоНДФЛ = Перечисления.СтатусыНалогоплательщиковПоНДФЛ.УчастникПрограммыПоПереселениюСоотечественников Тогда
		ТекстОписания = "Физическое лицо - нерезидент является участником Государственной программы по оказанию содействия добровольному переселению в Российскую Федерацию соотечественников, проживающих за рубежом." + Символы.ПС + "При исчислении НДФЛ с оплаты труда будет применяться ставка 13%";
	ИначеЕсли  СтатусНалогоплательщикаПоНДФЛ = Перечисления.СтатусыНалогоплательщиковПоНДФЛ.ЧленЭкипажаСуднаПодФлагомРФ Тогда
		ТекстОписания = "Физическое лицо - нерезидент является членом экипажа судна, плавающего под Государственным флагом РФ." + Символы.ПС + "При исчислении НДФЛ с оплаты труда будет применяться ставка 13%";
	ИначеЕсли  СтатусНалогоплательщикаПоНДФЛ = Перечисления.СтатусыНалогоплательщиковПоНДФЛ.Беженец Тогда
		ТекстОписания = "Физическое лицо - нерезидент является беженцем (либо получено временное убежище)." + Символы.ПС + "При исчислении НДФЛ с оплаты труда будет применяться ставка 13%";
	ИначеЕсли  СтатусНалогоплательщикаПоНДФЛ = Перечисления.СтатусыНалогоплательщиковПоНДФЛ.ГражданинСтраныЕАЭС Тогда
		ТекстОписания = "Физическое лицо - нерезидент является гражданином Беларуси, Казахстана, Армении и Киргизии." + Символы.ПС + "Для граждан Беларуси, Казахстана и Армении статус применяется с 1 января 2015 года, для граждан Киргизии статус применяется с 12 августа 2015 года." + Символы.ПС + "При исчислении НДФЛ с оплаты труда будет применяться ставка 13%";
	ИначеЕсли  СтатусНалогоплательщикаПоНДФЛ = Перечисления.СтатусыНалогоплательщиковПоНДФЛ.НерезидентРаботающийНаОснованииПатента Тогда
		ТекстОписания = "Иностранный гражданин - нерезидент, осуществляющий трудовую деятельность по найму на основании патента." + Символы.ПС + "При исчислении НДФЛ с оплаты труда будет применяться ставка 13%";
	КонецЕсли;	
...
Процедура ПолучитьСтатусНалогоплательщикаПоНДФЛ(ЭтаФорма) Экспорт
	...
	Иначе
		...
		СтрокаТаблицы.Период  = НачалоГода(ОбщегоНазначенияЗК.ПолучитьРабочуюДату());
...
Процедура ОбработатьОповещениеОбИзмененииИсторииСтатусНалогоплательщикаПоНДФЛ(ЭтаФорма, ТаблицаИсторииЗначений) Экспорт
	...
	Иначе
		...
		ЭтаФорма.ДатаСтатусНалогоплательщикаПоНДФЛ = НачалоГода(ОбщегоНазначенияЗК.ПолучитьРабочуюДату());
	КонецЕсли; 
