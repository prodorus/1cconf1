...
Функция ПрефиксИнформационнойБазыПоУмолчанию() Экспорт
	...
	Возврат глЗначениеПеременной("ПрефиксУзлаРаспределеннойИнформационнойБазы");
...
// Возвращает поддерживаемые версии формата обмена.
Функция ПолучитьВерсииУниверсальногоФорматаОбмена() Экспорт
	ВерсииФормата = Новый Массив;
	ВерсииФормата.Добавить("1.2");
	ВерсииФормата.Добавить("1.3");
	ВерсииФормата.Добавить("1.4");
	ВерсииФормата.Добавить("1.5");
	Возврат ВерсииФормата;
КонецФункции

// Возвращает пространство имен универсального формата обмена.
Функция ПространствоИменУниверсальногоФорматаОбмена() Экспорт
	Возврат "http://v8.1c.ru/edi/edi_stnd/EnterpriseData";
КонецФункции

// Возвращает модуль менеджера обмена через универсальный формат.
Функция МенеджерУниверсальногоФорматаОбмена() Экспорт
	Возврат МенеджерОбменаЧерезУниверсальныйФормат;
КонецФункции

Функция ИмяПланаОбменаЧерезУниверсальныйФормат() Экспорт
