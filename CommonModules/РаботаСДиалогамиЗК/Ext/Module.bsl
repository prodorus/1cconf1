...
Функция ПолучитьСведенияОВидеРасчетаСхемыМотивации(СведенияОВидахРасчета, ВидРасчета, Режим = "ПлановыеНачисления") Экспорт
	...
	Возврат ЗаполнениеДокументовЗК.ПолучитьСведенияОВидеРасчетаСхемыМотивации(СведенияОВидахРасчета, ВидРасчета, Режим);
...
Процедура ЗаполнитьСведенияОВидахРасчетаОформляемыхСтрок(СведенияОВидахРасчета, ОформляемыеСтроки, ИмяПоляВидРасчета = "ВидРасчета", Режим = "ПлановыеНачисления") Экспорт
	...
	ПоляВидРасчета = ОбщегоНазначенияЗК.РазложитьСтрокуВМассивПодстрок(ИмяПоляВидРасчета);
	...
	Для каждого Строка Из ОформленияСтрок Цикл
		...
		Если ТипЗнч(ВидРасчета) = Тип("ПланВидовРасчетаСсылка.ОсновныеНачисленияОрганизаций") Тогда
			...
			Иначе
				...
				СведенияОВидеРасчета = мСведенияОВидахРасчета[ДанныеСтроки.ВидРасчетаЗавершения];
...
Процедура ОбработатьОтображениеПоказателейДляРасчета(ТабличноеПоле, ОформленияСтрокТабличногоПоля, СведенияОВидахРасчета, Режим = "ПриРасчете", ВидРасчета = Неопределено) Экспорт
	...
	Если ВидРасчета <> Неопределено Тогда
		ПолучитьСведенияОВидеРасчетаСхемыМотивации(СведенияОВидахРасчета, ВидРасчета, Режим);
	Иначе
		ЗаполнитьСведенияОВидахРасчетаОформляемыхСтрок(СведенияОВидахРасчета, ОформленияСтрокТабличногоПоля, , Режим);
	КонецЕсли;
...
Процедура УстановитьФорматЗначенийПоказателейОформленияСтрок(ОформленияСтрок, ДанныеОформленияЗначенийПоказателей) Экспорт
	...
	ОбновитьДанныеОформленияЗначенийПоказателей(ДанныеОформленияЗначенийПоказателей, Показатели);
...
Процедура ОформитьКолонкиНДФЛ(КолонкиНДФЛ) Экспорт
	...
	МассивСсылок.Добавить(Справочники.ВычетыНДФЛ.Код117о);
	МассивСсылок.Добавить(Справочники.ВычетыНДФЛ.Код121о);
	МассивСсылок.Добавить(Справочники.ВычетыНДФЛ.Код125о);
	МассивСсылок.Добавить(Справочники.ВычетыНДФЛ.Код130);
	МассивСсылок.Добавить(Справочники.ВычетыНДФЛ.Код131);
	МассивСсылок.Добавить(Справочники.ВычетыНДФЛ.Код132);
	МассивСсылок.Добавить(Справочники.ВычетыНДФЛ.Код135);
	МассивСсылок.Добавить(Справочники.ВычетыНДФЛ.Код137);
	МассивСсылок.Добавить(Справочники.ВычетыНДФЛ.Код139);
	МассивСсылок.Добавить(Справочники.ВычетыНДФЛ.Код143);
	МассивСсылок.Добавить(Справочники.ВычетыНДФЛ.Код145);
	МассивСсылок.Добавить(Справочники.ВычетыНДФЛ.Код147);
	МассивСсылок.Добавить(Справочники.ВычетыНДФЛ.Код320о);
	МассивСсылок.Добавить(Справочники.ВычетыНДФЛ.Код321);
	МассивСсылок.Добавить(Справочники.ВычетыНДФЛ.Код324);
	МассивСсылок.Добавить(Справочники.ВычетыНДФЛ.Код325);
	МассивСсылок.Добавить(Справочники.ВычетыНДФЛ.Код326);
	МассивСсылок.Добавить(Справочники.ВычетыНДФЛ.Код329);
	Представления = ОбщегоНазначенияЗК.ПолучитьПредставленияОбъектов(МассивСсылок);
	...
	КолонкиНДФЛ.ПримененныйВычетНаДетейОпекунов.ТекстШапки = Представления[Справочники.ВычетыНДФЛ.Код130];
	КолонкиНДФЛ.ПримененныйВычетНаДетейДвойнойОпекунов.ТекстШапки = Представления[Справочники.ВычетыНДФЛ.Код135];
	КолонкиНДФЛ.ПримененныйВычетНаДетейДвойнойВторойОпекунов.ТекстШапки = Представления[Справочники.ВычетыНДФЛ.Код143];
	КолонкиНДФЛ.ПримененныйВычетНаВторогоРебенкаОпекунов.ТекстШапки = Представления[Справочники.ВычетыНДФЛ.Код131];
	КолонкиНДФЛ.ПримененныйВычетНаВторогоРебенкаДвойнойОпекунов.ТекстШапки = Представления[Справочники.ВычетыНДФЛ.Код137];
	КолонкиНДФЛ.ПримененныйВычетНаВторогоРебенкаДвойнойВторойОпекунов.ТекстШапки = Представления[Справочники.ВычетыНДФЛ.Код145];
	КолонкиНДФЛ.ПримененныйВычетНаТретьегоРебенкаОпекунов.ТекстШапки = Представления[Справочники.ВычетыНДФЛ.Код132];
	КолонкиНДФЛ.ПримененныйВычетНаТретьегоРебенкаДвойнойОпекунов.ТекстШапки = Представления[Справочники.ВычетыНДФЛ.Код139];
	КолонкиНДФЛ.ПримененныйВычетНаТретьегоРебенкаДвойнойВторойОпекунов.ТекстШапки = Представления[Справочники.ВычетыНДФЛ.Код147];
	КолонкиНДФЛ.ПримененныйВычетНаДетейИнвалидовОпекунов.ТекстШапки = Представления[Справочники.ВычетыНДФЛ.Код117о];
	КолонкиНДФЛ.ПримененныйВычетНаДетейИнвалидовДвойнойОпекунов.ТекстШапки = Представления[Справочники.ВычетыНДФЛ.Код121о];
	КолонкиНДФЛ.ПримененныйВычетНаДетейИнвалидовДвойнойВторойОпекунов.ТекстШапки = Представления[Справочники.ВычетыНДФЛ.Код125о];
	КолонкиНДФЛ.ПримененныйВычетРасходыНаСвоеОбучение.ТекстШапки = Представления[Справочники.ВычетыНДФЛ.Код320о];
	КолонкиНДФЛ.ПримененныйВычетРасходыНаОбучениеДетей.ТекстШапки = Представления[Справочники.ВычетыНДФЛ.Код321];
	КолонкиНДФЛ.ПримененныйВычетРасходыНаЛечение.ТекстШапки = Представления[Справочники.ВычетыНДФЛ.Код324];
	КолонкиНДФЛ.ПримененныйВычетСтраховыеВзносыНаМедУслуги.ТекстШапки = Представления[Справочники.ВычетыНДФЛ.Код325];
	КолонкиНДФЛ.ПримененныйВычетРасходыНаДорогостоящееЛечение.ТекстШапки = Представления[Справочники.ВычетыНДФЛ.Код326];
	КолонкиНДФЛ.ПримененныйВычетВзносыНаДобровольноеСтрахованиеЖизни.ТекстШапки = Представления[Справочники.ВычетыНДФЛ.Код329];

КонецПроцедуры

Процедура ОтобразитьКолонкиНДФЛ(КолонкиНДФЛ) Экспорт
	...
	БлокКолонок.Добавить(КолонкиНДФЛ.ПримененныйВычетНаДетейОпекунов);
	БлокКолонок.Добавить(КолонкиНДФЛ.ПримененныйВычетНаДетейДвойнойОпекунов);
	БлокКолонок.Добавить(КолонкиНДФЛ.ПримененныйВычетНаДетейДвойнойВторойОпекунов);
	ПеренестиБлокКолонокЦеликом(КолонкиНДФЛ, КолонкиНДФЛ.ЗаголовокВычетовНаДетей, БлокКолонок);
	...
	БлокКолонок.Добавить(КолонкиНДФЛ.ПримененныйВычетНаВторогоРебенкаОпекунов);
	БлокКолонок.Добавить(КолонкиНДФЛ.ПримененныйВычетНаВторогоРебенкаДвойнойОпекунов);
	БлокКолонок.Добавить(КолонкиНДФЛ.ПримененныйВычетНаВторогоРебенкаДвойнойВторойОпекунов);
	ПеренестиБлокКолонокЦеликом(КолонкиНДФЛ, КолонкиНДФЛ.ЗаголовокВычетовНаВторыхДетей, БлокКолонок);
	...
	БлокКолонок.Добавить(КолонкиНДФЛ.ПримененныйВычетНаТретьегоРебенкаОпекунов);
	БлокКолонок.Добавить(КолонкиНДФЛ.ПримененныйВычетНаТретьегоРебенкаДвойнойОпекунов);
	БлокКолонок.Добавить(КолонкиНДФЛ.ПримененныйВычетНаТретьегоРебенкаДвойнойВторойОпекунов);
	ПеренестиБлокКолонокЦеликом(КолонкиНДФЛ, КолонкиНДФЛ.ЗаголовокВычетовНаТретьихДетей, БлокКолонок);
	...
	ПеренестиБлокКолонокЦеликом(КолонкиНДФЛ, КолонкиНДФЛ.ЗаголовокВычетовНаДетейИнвалидов, БлокКолонок);
	...
	ПеренестиБлокКолонокЦеликом(КолонкиНДФЛ, КолонкиНДФЛ.ЗаголовокИмущественныхВычетов, БлокКолонок);
	...
	ПеренестиБлокКолонокЦеликом(КолонкиНДФЛ, КолонкиНДФЛ.ЗаголовокСоциальныхВычетов, БлокКолонок);
...
Процедура ПриИзмененииВидаРасчета(ИмяОбъекта, Значение, ЭлементыФормы, мСведенияОВидахРасчета, мВалюта) Экспорт
	...
	УстановитьФорматЗначенийПоказателей(ЭлементыФормы[ИмяОбъекта], мСведенияОВидахРасчета);
	...
	Пока ВыборкаПоВидамРасчета.Следующий() Цикл
		...
		Пока Выборка.Следующий() Цикл
			...
			Если Сотрудников > 3 Тогда
				...
				Прервать;
			КонецЕсли;
			ТекстСотрудники = ТекстСотрудники + ?(ЗначениеЗаполнено(ТекстСотрудники), ", ", "") + ОбщегоНазначенияЗК.ФамилияИнициалыФизЛица(Выборка.Сотрудник); 
		КонецЦикла;
...
Процедура УстановитьДоступностьФормыДляРедактирования(ДокументОбъект, ФормаДокумента) Экспорт
	...
	Если НЕ ФормаДокумента.ТолькоПросмотр Тогда
		ФормаДокумента.ТолькоПросмотр = ФормаДокумента.ТолькоПросмотр Или НастройкаПравДоступа.ДокументВЗакрытомПериоде(ДокументОбъект);
	КонецЕсли;
...
Процедура УстановитьЗаголовокФормыЗаписиФизлица(СтрокаОписания, ФизЛицо, ФормаЗаписи) Экспорт
	...
	ФормаЗаписи.Заголовок = СтрокаОписания + ": " + ОбщегоНазначенияЗК.ПолучитьПредставленияОбъектов(ФизЛицо);
...
Процедура ОткрытьФормуРедактированияДатыВыплатыСотрудников(ДокументОбъект, ФормаДокумента, КлючУникальности = Неопределено) Экспорт

	Форма = ПолучитьОбщуюФорму("РедактированиеДатыВыплатыСотрудников", ФормаДокумента, ?(КлючУникальности = Неопределено, ФормаДокумента, КлючУникальности));
...
Процедура ОтменитьИсправлениеДокумента(ИсправленныйДокумент, ИмяРеквизитаИсправляемыйДокумент = "ПерерассчитываемыйДокумент") Экспорт 
	...
	Если ВсегоИсправлений <> 0 Тогда
		...
		ТекстВопроса =  ОбщегоНазначенияЗК.ФормаМножественногоЧисла("Найден ","Найдено ","Найдено ",ВсегоИсправлений) + ВсегоИсправлений 
			+ ОбщегоНазначенияЗК.ФормаМножественногоЧисла(" документ-исправление"," документа-исправления"," документов-исправлений",ВсегоИсправлений) 
			+ ОбщегоНазначенияЗК.ФормаМножественногоЧисла(", зарегистрированный ",", зарегистрированных ",", зарегистрированных ",ВсегоИсправлений) 
...
Функция ОбновитьКнопкуИсправленияРасчетовСотрудника(ТипДанных, ТекущийСотрудник, СотрудникиСИсправлениями, Кнопка, ИмяБезСотрудника = "Расчеты текущего сотрудника", ИмяССотрудником = "Расчеты") Экспорт
	...
	Иначе
		...
		ФИО = ОбщегоНазначенияЗК.ПредставлениеРаботника(ТекущийСотрудник, 2);
...
Процедура ОбновитьДоступностьЭлементовФормыДляКадровыхИсправлений(ЭтотОбъект, ЭтаФорма, СтруктураМенюИсправление, ДокументыИсправление, СотрудникиИсправление)
	...
	ЭтаФорма.ТолькоПросмотр = ЭтаФорма.ТолькоПросмотр Или ДокументИсправлен;
...
Процедура УстановитьБыстрыйОтборПоОрганизации(Форма, ИмяСпискаДокументов, ОтборПоГоловнойОрганизации) 
	...
	Если ЗначениеЗаполнено(ПараметрТекущаяСтрока) Тогда
		ЗначениеОтбора = ОбщегоНазначенияЗК.ПолучитьЗначениеРеквизита(ПараметрТекущаяСтрока, "Организация");
	Иначе
	...
	ГоловнаяОрганизация = ОбщегоНазначенияЗК.ПолучитьЗначениеРеквизита(ЗначениеОтбора, "ГоловнаяОрганизация");
...
//
Функция ПредставлениеТарифаСтраховыхВзносов(ТарифСтраховыхВзносов) Экспорт
	
	ОписаниеТарифа = "Тариф не указан";
	
	Если ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.ОбщийНалоговыйРежим Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.УпрощенныйНалоговыйРежим Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.ЕНВД Тогда
		ОписаниеТарифа = "С 2017 года применяются ставки основного тарифа страховых взносов, установленные статьями 425 и 426 НК РФ (с 2011 по 2016 годы -  статьями 12 и 58.2 Федерального закона от 24 июля 2009 г. № 212-ФЗ)"
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.СельХозПроизводители Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.ЕСХН Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.ОрганизацияИнвалидов Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.НародныеХудожественныеПромыслы Тогда
		ОписаниеТарифа = "С 2017 года применяются ставки основного тарифа страховых взносов, установленные статьями 425 и 426 НК РФ (на 2010 год тариф был установлен пунктом 1 части 2 статьи 57, на 2011-2014 годы пунктом 1 части 1 статьи 58, в 2015 и 2016 годах применялись ставки основного тарифа страховых взносов, установленные статьями 12 и 58.2 Федерального закона от 24 июля 2009 г. № 212-ФЗ)"
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.СМИ Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.ОрганизацииОказывающиеИнжиниринговыеУслуги Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.ХозОбществаБюджетныхВУЗов Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.РезидентТехникоВнедренческойЗоны Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.ITОрганизации Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.ДляЧленовЭкипажейМорскихСудовПодФлагомРФ Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.УпрощенныйНалоговыйРежимПроизводство Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.ДляФармацевтовАптек Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.НекоммерческиеОрганизации Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.БлаготворительныеОрганизации Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.ИндивидуальныйПредпринимательПрименяющийПатент Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.УчастникПроектаИнновационныйЦентрСколково Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.УчастникОсобойЗоныВКрыму Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.РезидентТерриторииОпережающегоСоциальноЭкономическогоРазвития Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.РезидентПортаВладивосток Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.Мультипликаторы Тогда
	...
	ИначеЕсли ТарифСтраховыхВзносов = Перечисления.ТарифыСтраховыхВзносов.РезидентОсобойЗоныВКалининградскойОбласти Тогда
...
Функция ПредставлениеВидаДоходаПоСтраховымВзносам(ВидДохода) Экспорт
	...
	Если ВидДохода = Справочники.ДоходыПоСтраховымВзносам.ДоговорыГПХ Тогда
		РасшифровкаВидДохода = "Вознаграждения, выплачиваемые по договорам гражданско-правового характера. Облагаются страховыми взносами на ОПС и ОМС целиком, не облагаются страховыми взносами в ФСС, подпункт 2 пункта 3 статьи 422 НК РФ (до 2017 года - пункт 2 части 3 статьи 9 Федерального закона от 24 июля 2009 года № 212-ФЗ)"
	ИначеЕсли ВидДохода = Справочники.ДоходыПоСтраховымВзносам.ДоговорыГПХОблагаемыеФСС_НС Тогда
		РасшифровкаВидДохода = "Вознаграждения, выплачиваемые по договорам гражданско-правового характера, если в условия договора включена уплата взносов на страхование от несчастных случаев и профзаболеваний. Облагаются страховыми взносами на ОПС и ОМС целиком, не облагаются страховыми взносами в ФСС на страхование по временной нетрудоспособности, подпункт 2 пункта 3 статьи 422 НК РФ (до 2017 года - пункт 2 части 3 статьи 9 Федерального закона от 24 июля 2009 года № 212-ФЗ)"
	ИначеЕсли ВидДохода = Справочники.ДоходыПоСтраховымВзносам.Матпомощь Тогда
		РасшифровкаВидДохода = "Облагается страховыми взносами на ОПС и ОМС и в ФСС частично, подпункт 11 пункта 1 статьи 422 НК РФ (до 2017 года - пункт 11 части 1 статьи 9 Федерального закона от 24 июля 2009 года № 212-ФЗ)"
	ИначеЕсли ВидДохода = Справочники.ДоходыПоСтраховымВзносам.МатпомощьПрокуроров Тогда
		РасшифровкаВидДохода = "Облагается страховыми взносами на ОМС и ФСС частично, подпункт 11 пункта 1 статьи 422 НК РФ (до 2017 года - пункт 11 части 1 статьи 9 Федерального закона от 24 июля 2009 года № 212-ФЗ), не облагаются страховыми взносами на ОПС, подпункт 1 пункта 3 статьи 422 НК РФ (до 2017 года - пункт 1 части 3 статьи 9 Федерального закона от 24 июля 2009 года № 212-ФЗ)"
	ИначеЕсли ВидДохода = Справочники.ДоходыПоСтраховымВзносам.МатпомощьПриРожденииРебенка Тогда
		РасшифровкаВидДохода = "Облагается страховыми взносами на ОПС и ОМС и в ФСС частично, абзац 4 подпункта 3 пункта 1 статьи 422 НК РФ (до 2017 года - подпункт в) пункта 3 части 1 статьи 9 Федерального закона от 24 июля 2009 года № 212-ФЗ)"
	ИначеЕсли ВидДохода = Справочники.ДоходыПоСтраховымВзносам.МатпомощьПриРожденииРебенкаПрокуроров Тогда
		РасшифровкаВидДохода = "Облагается страховыми взносами на ОМС и в ФСС частично, абзац 4 подпункта 3 пункта 1 статьи 422 НК РФ (до 2017 года - подпункт в) пункта 3 части 1 статьи 9 Федерального закона от 24 июля 2009 года № 212-ФЗ), не облагаются страховыми взносами на ОПС, подпункт 1 пункта 3 статьи 422 НК РФ (до 2017 года - пункт 1 части 3 статьи 9 Федерального закона от 24 июля 2009 года № 212-ФЗ)"
	ИначеЕсли ВидДохода = Справочники.ДоходыПоСтраховымВзносам.НеОблагаетсяЦеликом Тогда
		РасшифровкаВидДохода = "Является объектом обложения, но не облагается целиком страховыми взносами на ОПС и ОМС и в ФСС на основании пункта 1 статьи 422 НК РФ (до 2017 года - части 1 статьи 9 Федерального закона от 24 июля 2009 года № 212-ФЗ) кроме пособий по социальному страхованию за счет ФСС, частично облагаемой материальной помощи и денежного довольствия"
	ИначеЕсли ВидДохода = Справочники.ДоходыПоСтраховымВзносам.НеОблагаетсяЦеликомПрокуроров Тогда
		РасшифровкаВидДохода = "Доходы прокуроров, следователей и судей, целиком не облагаемые страховыми взносами на ОПС и ОМС и в ФСС на основании пункта 1 статьи 422 НК РФ (до 2017 года - части 1 статьи 9 Федерального закона от 24 июля 2009 года № 212-ФЗ) кроме пособий по социальному страхованию за счет ФСС, частично облагаемой материальной помощи и денежного довольствия"
	ИначеЕсли ВидДохода = Справочники.ДоходыПоСтраховымВзносам.НеЯвляетсяОбъектом Тогда
		РасшифровкаВидДохода = "Не является объектом обложения страховыми взносами на ОПС и ОМС и в ФСС в соответствии с пунктами 4-7 статьи 420 НК РФ (до 2017 года - частями 3-9 статьи 7 Федерального закона от 24 июля 2009 года № 212-ФЗ)." + Символы.ПС + "Внимание! Эти суммы не будут включены в отчетность по страховым взносам."
	ИначеЕсли ВидДохода = Справочники.ДоходыПоСтраховымВзносам.ОблагаетсяЦеликом Тогда
		РасшифровкаВидДохода = "Облагается целиком страховыми взносами на ОПС и ОМС и в ФСС на страхование по временной нетрудоспособности, а также от несчастных случаев и профзаболеваний"
	ИначеЕсли ВидДохода = Справочники.ДоходыПоСтраховымВзносам.ОблагаетсяЦеликомНеОблагаемыеФСС_НС Тогда
		РасшифровкаВидДохода = "Облагается целиком страховыми взносами на ОПС и ОМС и в ФСС на страхование по временной нетрудоспособности, не облагается взносами на страхование от несчастных случаев и профзаболеваний в соответствии с пунктом 2 статьи 20.2 Федерального закона от 24 июля 1998 года № 125-ФЗ"
	ИначеЕсли ВидДохода = Справочники.ДоходыПоСтраховымВзносам.ПособияЗаСчетФСС Тогда
		РасшифровкаВидДохода = "Не облагаются целиком страховыми взносами на ОПС и ОМС и в ФСС в соответствии с подпунктом 1 пункта 1 статьи 422 НК РФ (до 2017 года - пунктом 1 части 1 статьи 9 Федерального закона от 24 июля 2009 года № 212-ФЗ)"
	...
	ИначеЕсли ВидДохода = Справочники.ДоходыПоСтраховымВзносам.ДенежноеДовольствиеВоеннослужащих Тогда
		РасшифровкаВидДохода = "Не облагается целиком страховыми взносами на ОПС и ОМС и в ФСС в соответствии с подпунктом 14 пункта 1 статьи 422 НК РФ (до 2017 года - пунктом 14 части 1 статьи 9 Федерального закона от 24 июля 2009 года № 212-ФЗ)"
	ИначеЕсли ВидДохода = Справочники.ДоходыПоСтраховымВзносам.ДенежноеСодержаниеПрокуроров Тогда
		РасшифровкаВидДохода = "Облагается целиком страховыми взносами на ОМС и в ФСС, не облагаются страховыми взносами на ОПС, подпункт 1 пункта 3 статьи 422 НК РФ (до 2017 года - пункт 1 части 3 статьи 9 Федерального закона от 24 июля 2009 года № 212-ФЗ)"
	ИначеЕсли ВидДохода = Справочники.ДоходыПоСтраховымВзносам.ДенежноеСодержаниеПрокуроровНеОблагаемыеФСС_НС Тогда
		РасшифровкаВидДохода = "Облагается целиком страховыми взносами на ОМС и в ФСС на страхование по временной нетрудоспособности, не облагается взносами на страхование от несчастных случаев и профзаболеваний в соответствии с пунктом 2 статьи 20.2 Федерального закона от 24 июля 1998 года № 125-ФЗ, не облагаются страховыми взносами на ОПС, подпункт 1 пункта 3 статьи 422 НК РФ (до 2017 года - пункт 1 части 3 статьи 9 Федерального закона от 24 июля 2009 года № 212-ФЗ)"
	ИначеЕсли ВидДохода = Справочники.ДоходыПоСтраховымВзносам.ДоходыСтудентовЗаРаботуВСтудотрядеПоГражданскоПравовомуДоговору Тогда
		РасшифровкаВидДохода = "Облагаются страховыми взносами на ОМС целиком, не облагаются страховыми взносами на ОПС и в ФСС, подпункты 1 и 2 пункта 3 статьи 422 НК РФ (до 2017 года - пункты 1, 2 части 3 статьи 9 Федерального закона от 24 июля 2009 года № 212-ФЗ)"
	ИначеЕсли ВидДохода = Справочники.ДоходыПоСтраховымВзносам.ДоходыСтудентовЗаРаботуВСтудотрядеПоТрудовомуДоговору Тогда
		РасшифровкаВидДохода = "Облагается страховыми взносами на ОМС и в ФСС целиком, не облагаются страховыми взносами на ОПС, подпункт 1 пункта 3 статьи 422 НК РФ (до 2017 года - пункт 1 части 3 статьи 9 Федерального закона от 24 июля 2009 года № 212-ФЗ)"
	ИначеЕсли ЗначениеЗаполнено(ВидДохода) Тогда // различные авторские
		Если ОбщегоНазначенияЗК.ПолучитьЗначениеРеквизита(ВидДохода,"ВходитВБазуФСС_НС") Тогда
			РасшифровкаВидДохода = "Авторские вознаграждения, если в условия договора включена уплата взносов на страхование от несчастных случаев и профзаболеваний. При исчислении страховых взносов на ОПС и ОМС учитываются произведенные расходы в соответствии с пунктами 8 и 9 статьи 421 НК РФ (до 2017 года - частью 7 статьи 8 Федерального закона от 24 июля 2009 года № 212-ФЗ), не облагаются страховыми взносами в ФСС на страхование по временной нетрудоспособности, подпункт 2 пункта 3 статьи 422 НК РФ (до 2017 года - пункт 2 части 3 статьи 9 Федерального закона от 24 июля 2009 года № 212-ФЗ)";
		Иначе 	
			РасшифровкаВидДохода = "При исчислении страховых взносов на ОПС и ОМС учитываются произведенные расходы в соответствии с пунктами 8 и 9 статьи 421 НК РФ (до 2017 года - частью 7 статьи 8 Федерального закона от 24 июля 2009 года № 212-ФЗ), не облагаются страховыми взносами в ФСС, подпункт 2 пункта 3 статьи 422 НК РФ (до 2017 года - пункт 2 части 3 статьи 9 Федерального закона от 24 июля 2009 года № 212-ФЗ)";
		КонецЕсли;	
	ИначеЕсли ВидДохода = Справочники.ДоходыПоСтраховымВзносам.ПустаяСсылка() Тогда
		РасшифровкаВидДохода = "Не указан порядок учета начисления для целей исчисления страховых взносов на ОПС и ОМС и в ФСС"
	Иначе
		РасшифровкаВидДохода = "Не отражается в учете для целей исчисления взносов на ОПС и ОМС и в ФСС"
	КонецЕсли;
...
Функция ПолучитьПредставлениеВидаДоходаПоНУ(ВидНачисления) Экспорт
	...
	ИначеЕсли ВидНачисления = Перечисления.ВидыНачисленийОплатыТрудаПоСт255НК.пп15ст255 Тогда
		РасшифровкаВидНачисления = "(утратил силу с 1 января 2010 года) Расходы на доплату до фактического заработка в случае временной утраты трудоспособности, установленную законодательством РФ"
	...
	ИначеЕсли ВидНачисления = Перечисления.ВидыНачисленийОплатыТрудаПоСт255НК.пп24_1ст255 Тогда
		РасшифровкаВидНачисления = "Расходы на возмещение затрат работников по уплате процентов по займам (кредитам) на приобретение и (или) строительство жилого помещения"
