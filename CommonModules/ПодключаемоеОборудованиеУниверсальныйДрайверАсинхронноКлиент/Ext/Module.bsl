...
Процедура НачатьПодключениеУстройства(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ДополнительныеПараметры) Экспорт
	...
	ОповещениеПриУстановкеПараметров = ОписаниеОповещенияЕГАИС("НачатьПодключениеУстройства_УстановкаПараметровЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьПодключениеУстройства_УстановкаПараметровЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	ОповещениеПолучитьОписаниеЗавершение = ОписаниеОповещенияЕГАИС("НачатьПодключениеУстройства_ПолучитьОписаниеЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
	Попытка
	...
	Исключение
		...
		Если ДополнительныеПараметры.ОповещениеПриЗавершении <> Неопределено Тогда
			...
			ВыполнитьОбработкуОповещенияЕГАИС(ДополнительныеПараметры.ОповещениеПриЗавершении, Результат);
		КонецЕсли;
	КонецПопытки;
...
Процедура НачатьПодключениеУстройства_ПолучитьОписаниеЗавершение(РезультатВыполнения, ПараметрыВызова, ДополнительныеПараметры) Экспорт
	...
	ОповещениеПодключитьЗавершение = ОписаниеОповещенияЕГАИС("НачатьПодключениеУстройства_ПодключитьЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
	Попытка
...
Процедура НачатьПодключениеУстройства_ПодключитьЗавершение(РезультатВыполнения, ПараметрыВызова, ДополнительныеПараметры) Экспорт
	...
	Если НЕ РезультатВыполнения Тогда
		...
		ОповещениеПодключитьЗавершение = ОписаниеОповещенияЕГАИС("ПолучениеОшибкиЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
		Попытка
	...
	Иначе
		...
		Если ПараметрыПодключения.ТипОборудования = "ПринтерЧеков" 
			...
			ОповещениеЗавершение = ОписаниеОповещенияЕГАИС("НачатьПодключениеУстройства_ПолучениеШириныСтрокиЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьОтключениеУстройства(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры) Экспорт
	...
	ОповещениеМетода = ОписаниеОповещенияЕГАИС("НачатьОтключениеУстройства_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ПараметрыКоманды);
	...
	Исключение
		...
		Если ОповещениеПриЗавершении <> Неопределено Тогда
			Результат = Новый Структура("Результат, ВыходныеПараметры", Ложь, ВыходныеПараметры);
			ВыполнитьОбработкуОповещенияЕГАИС(ОповещениеПриЗавершении, Результат);
		КонецЕсли;
	КонецПопытки;
...
Процедура ВыполнениеМетодаЗавершение(РезультатВыполнения, Параметры, ДополнительныеПараметры) Экспорт
	...
	Иначе
		ОписаниеОшибки = "";
		ОповещениеПриОшибке = ОписаниеОповещенияЕГАИС("ПолучениеОшибкиЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьПолучениеШириныСтроки(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры) Экспорт 
	...
	Попытка
		Оповещение = ОписаниеОповещенияЕГАИС("ВыполнениеМетодаЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьАннулированиеЧека(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ТипЧека, ФискальныйЧек, ВходныеПараметры, ВыходныеПараметры);
	...
	Если ПараметрыПодключения.ТипОборудования = "ФискальныйРегистратор" Тогда
		...
		Оповещение = ОписаниеОповещенияЕГАИС("НачатьАннулированиеЧека_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьПечатьТекста(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, СтрокаТекста, ВыходныеПараметры) Экспорт
	...
	ИначеЕсли ПараметрыПодключения.ТипОборудования = "ФискальныйРегистратор" Тогда
		Оповещение = ОписаниеОповещенияЕГАИС("НачатьПечатьТекста_ОткрытиеЧекаЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьПечатьЧекаКоррекции(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВходныеПараметры, ВыходныеПараметры) Экспорт
	...
	Попытка
		Оповещение = ОписаниеОповещенияЕГАИС("НачатьПечатьЧекаКоррекции_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьОткрытиеСмены(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВходныеПараметры, ВыходныеПараметры)
	...
	Если ПараметрыПодключения.ТипОборудования = "ККТ" Тогда
		...
		Попытка
			ПараметрыОперации = МенеджерОборудованияВызовСервера.ПолучитьXMLПакетДляОперации(ВходныеПараметры);
			Оповещение = ОписаниеОповещенияЕГАИС("НачатьОперациюСоСменой_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
	...
	ИначеЕсли ПараметрыПодключения.ТипОборудования = "ФискальныйРегистратор" 
		...
		Попытка
			Оповещение = ОписаниеОповещенияЕГАИС("НачатьОткрытиеСмены_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьПолучениеТекущееСостояние(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры)
	...
	ПараметрыСостояния = "";
	Попытка
		Оповещение = ОписаниеОповещенияЕГАИС("НачатьПолучениеТекущееСостояние_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьПолучениеПараметровККТ(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВходныеПараметры, ВыходныеПараметры);
	...
	Попытка
		Оповещение = ОписаниеОповещенияЕГАИС("НачатьПолучениеПараметровККТ_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьФискализациюЧека(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВходныеПараметры, ВыходныеПараметры) Экспорт
	...
	Если ПараметрыПодключения.ТипОборудования = "ФискальныйРегистратор" Тогда
		...
		Иначе
			Оповещение = ОписаниеОповещенияЕГАИС("НачатьПечатьЧекаПоШаблону_ОткрытиеЧекаЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
	...
	ИначеЕсли ПараметрыПодключения.ТипОборудования = "ККТ" Тогда 
		...
		Попытка
			Оповещение = ОписаниеОповещенияЕГАИС("НачатьФискализациюЧека_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьПечатьЧекаПоШаблону_ПечатьСтрокиЗавершение(РезультатВыполнения, ДополнительныеПараметры) Экспорт
	...
	Если РезультатВыполнения.Результат Или ДополнительныеПараметры.ПечатьШтрихкода Тогда
		...
		Оповещение = ОписаниеОповещенияЕГАИС("НачатьПечатьЧекаПоШаблону_ПечатьСтрокиЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьПечатьТекста_ПечатьСтрокиЗавершение(РезультатВыполнения, ДополнительныеПараметры) Экспорт
	...
	Если РезультатВыполнения.Результат Или ДополнительныеПараметры.ПечатьШтрихкода Тогда
		...
		Оповещение = ОписаниеОповещенияЕГАИС("НачатьПечатьТекста_ПечатьСтрокиЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьОткрытиеЧека(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ТипЧека, ФискальныйЧек, ВыходныеПараметры) Экспорт
	...
	Попытка
		Оповещение = ОписаниеОповещенияЕГАИС("НачатьОткрытиеЧека_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьЗакрытиеЧека(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ТаблицаОплат, ВыходныеПараметры) Экспорт
	...
	ДополнительныеПараметры.Вставить("ОчисткаПараметров"      , Ложь);
	Попытка
		Оповещение = ОписаниеОповещенияЕГАИС("НачатьПечать_ПечатьЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьПечать_ПечатьЗавершение(РезультатВыполнения, Параметры, ДополнительныеПараметры) Экспорт
	...
	Иначе
		ОписаниеОшибки = "";
		ОповещениеПриОшибке = ОписаниеОповещенияЕГАИС("НачатьПечать_ОшибкаЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
		ДополнительныеПараметры.ОбъектДрайвера.НачатьВызовПолучитьОшибку(ОповещениеПриОшибке, ОписаниеОшибки);
	КонецЕсли;
...
Процедура НачатьПечать_ОшибкаЗавершение(РезультатВыполнения, Параметры, ДополнительныеПараметры) Экспорт
	...
	Оповещение = ОписаниеОповещенияЕГАИС("НачатьПечать_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьПечатьКвитанцийНаТерминале(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры)
	...
	Попытка
		Оповещение = ОписаниеОповещенияЕГАИС("НачатьПечатьКвитанцийНаТерминале_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьФормированиеИтоговДняПоКартам(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры);
	...
	Попытка
		Оповещение = ОписаниеОповещенияЕГАИС("НачатьФормированиеИтоговДняПоКартам_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьОплатуПлатежнойКартой(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения,
	...
	Попытка
		Оповещение = ОписаниеОповещенияЕГАИС("НачатьОперациюПоКарте_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьОтменуПреавторизацииПоПлатежнойКарте(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения,
	...
	Попытка
		Оповещение = ОписаниеОповещенияЕГАИС("НачатьОперациюПоКарте_ЗавершениеБезПараметров", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьВыгрузкуТаблицы(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ТаблицаВыгрузки, ПолнаяВыгрузка, ВыходныеПараметры)
	...
	Попытка
		...
		ОповещениеПриЗавершении = ОписаниеОповещенияЕГАИС("НачатьВыгрузкуТаблицы_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьЗагрузкуТаблицы(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры)
	...
	Попытка
		...
		ДополнительныеПараметры.Вставить("ВыходныеПараметры"      , ВыходныеПараметры);
		ДополнительныеПараметры.Вставить("ОповещениеПриЗавершении", ОповещениеПриЗавершении);
		ОповещениеПриЗавершении = ОписаниеОповещенияЕГАИС("НачатьЗагрузкуТаблицы_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьОчисткуТаблицу(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры)
	...
	Попытка
		...
		ДополнительныеПараметры.Вставить("ВыходныеПараметры"      , ВыходныеПараметры);
		ДополнительныеПараметры.Вставить("ОповещениеПриЗавершении", ОповещениеПриЗавершении);
		ОповещениеПриЗавершении = ОписаниеОповещенияЕГАИС("ВыполнениеМетодаЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьВыгрузкуТоваровВВесы(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ТаблицаВыгрузки, ЧастичнаяВыгрузка, ВыходныеПараметры)
	...
	Попытка
		...
		Состояние(НСтр("ru='Выгрузка данных...'"), Окр(ТекущийПакет * ПроцентИнкремент));
		Оповещение = ОписаниеОповещенияЕГАИС("НачатьВыгрузкуТоваровВВесы_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьПечатьЭтикеток(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ШаблонЭтикетки, МассивЭтикеток, ВыходныеПараметры)
	...
	Попытка
		...
		Оповещение = ОписаниеОповещенияЕГАИС("НачатьПечатьЭтикеток_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
...
Процедура НачатьПолучениеВерсииДрайвера(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры) Экспорт
	...
	ПараметрыКоманды.Вставить("ПараметрыПодключения"   , ПараметрыПодключения);
	ПараметрыКоманды.Вставить("ВыходныеПараметры"      , ВыходныеПараметры);
	ОповещениеМетода = ОписаниеОповещенияЕГАИС("НачатьПолучениеВерсииДрайвера_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ПараметрыКоманды);
...
Процедура НачатьУстановкуПараметров_Завершение(РезультатВыполнения, ПараметрыВызова, ДополнительныеПараметры) Экспорт
	...
	Если ДополнительныеПараметры.ПараметрыДляУстановки.Количество() > 0  Тогда
		Для Каждого Параметр Из ДополнительныеПараметры.ПараметрыДляУстановки Цикл
			...
			ОповещениеМетода = ОписаниеОповещенияЕГАИС("НачатьУстановкуПараметров_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
	...
	Иначе
		Если ДополнительныеПараметры.ОповещениеПриУстановкеПараметров <> Неопределено Тогда
			ВыполнитьОбработкуОповещенияЕГАИС(ДополнительныеПараметры.ОповещениеПриУстановкеПараметров, ДополнительныеПараметры);
		КонецЕсли;   
	КонецЕсли;
...
Процедура НачатьТестУстройства(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры)
	...
	ОповещениеПриУстановкеПараметров = ОписаниеОповещенияЕГАИС("НачатьТестУстройства_УстановкаПараметровЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
	НачатьУстановкуПараметров(ОповещениеПриУстановкеПараметров, ДополнительныеПараметры);
...
Процедура НачатьТестУстройства_УстановкаПараметровЗавершение(Результат, Параметры) Экспорт
	...
	Попытка
		Оповещение = ОписаниеОповещенияЕГАИС("НачатьТестУстройства_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", Параметры);
	...
	Исключение
		...
		Если Параметры.ОповещениеПриЗавершении <> Неопределено Тогда
			Результат = Новый Структура("Результат, ВыходныеПараметры", Ложь, ВыходныеПараметры);
			ВыполнитьОбработкуОповещенияЕГАИС(Параметры.ОповещениеПриЗавершении, Результат);
		КонецЕсли;
	КонецПопытки;
...
Процедура НачатьВыполнитьДополнительноеДействие(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ИмяДействия, ВыходныеПараметры);
	...
	ОповещениеПриУстановкеПараметров = ОписаниеОповещенияЕГАИС("НачатьВыполнитьДополнительноеДействие_УстановкаПараметровЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
	НачатьУстановкуПараметров(ОповещениеПриУстановкеПараметров, ДополнительныеПараметры);
...
Процедура НачатьВыполнитьДополнительноеДействие_УстановкаПараметровЗавершение(Результат, Параметры) Экспорт
	...
	ОповещениеЗавершение = ОписаниеОповещенияЕГАИС("НачатьВыполнитьДополнительноеДействие_Завершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", Параметры);
	Попытка
...
Процедура НачатьВыполнитьДополнительноеДействие_Завершение(РезультатВызова, ПараметрыВызова, ДополнительныеПараметры) Экспорт
	...
	Если РезультатВызова Тогда
		...
		КонецЕсли;
	Иначе
		ОповещениеПриЗавершении = ОписаниеОповещенияЕГАИС("ПолучениеОшибкиЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
		Попытка
			ТекстОшибки = "";
...
Процедура НачатьПолучениеОписаниеДрайвера(ОповещениеПриЗавершении, ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры)
	...
	ОповещениеМетода = ОписаниеОповещенияЕГАИС("НачатьПолучениеОписаниеДрайвера_ПолучитьНомерВерсииЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ПараметрыКоманды);
	Попытка
		ОбъектДрайвера.НачатьВызовПолучитьНомерВерсии(ОповещениеМетода);
	Исключение
...
Процедура НачатьПолучениеОписаниеДрайвера_ПолучитьНомерВерсииЗавершение(РезультатВызова, ПараметрыВызова, ДополнительныеПараметры) Экспорт
	...
	ОповещениеМетода = ОписаниеОповещенияЕГАИС("НачатьПолучениеОписаниеДрайвера_ПолучитьОписаниеЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
	Попытка
...
Процедура НачатьПолучениеОписаниеДрайвера_ПолучитьОписаниеЗавершение(РезультатВызова, ПараметрыВызова, ДополнительныеПараметры) Экспорт
	...
	ПараметрыДрайвера = "";
	ОповещениеМетода = ОписаниеОповещенияЕГАИС("НачатьПолучениеОписаниеДрайвера_ПолучитьПараметрыЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
	Попытка
...
Процедура НачатьПолучениеОписаниеДрайвера_ПолучитьПараметрыЗавершение(РезультатВызова, ПараметрыВызова, ДополнительныеПараметры) Экспорт
	...
	ДополнительныеДействия = "";
	ОповещениеМетода = ОписаниеОповещенияЕГАИС("НачатьПолучениеОписаниеДрайвера_ПолучитьДополнительныеДействияЗавершение", "ПодключаемоеОборудованиеУниверсальныйДрайверАсинхронноКлиент", ДополнительныеПараметры);
	Попытка                                    
