...
Функция ДанныеСотрудникаДляЗаявленияНаВыплатуПособия(Организация, Сотрудник, Дата, Режим = "ДляДокумента") Экспорт
	...
	|	ОтпускПоУходуЗаРебенком.АдресРегистрацииКодПоКЛАДР,
	|	ОтпускПоУходуЗаРебенком.АдресПочтовыйКодПоФИАС,
	|	ОтпускПоУходуЗаРебенком.АдресРегистрацииКодПоФИАС
	|ИЗ
	...
	|	РеестрСведенийВФССОПособияхПоНетрудоспособностиРаботникиОрганизации.НаличиеКартыМИР,
	|	РеестрСведенийВФССОПособияхПоНетрудоспособностиРаботникиОрганизации.НомерКартыМИР,
	...
	|	РеестрСведенийВФССОПособияхПоНетрудоспособностиРаботникиОрганизации.АдресПочтовыйКодПоФИАС,
	|	РеестрСведенийВФССОПособияхПоНетрудоспособностиРаботникиОрганизации.АдресРегистрацииКодПоФИАС
	|ИЗ
	...
	|	РеестрСведенийВФССОПособияхПриРожденииРебенкаРаботникиОрганизации.НаличиеКартыМИР,
	|	РеестрСведенийВФССОПособияхПриРожденииРебенкаРаботникиОрганизации.НомерКартыМИР,
	...
	|	РеестрСведенийВФССОПособияхПриРожденииРебенкаРаботникиОрганизации.АдресРегистрацииКодПоКЛАДР,
	|	РеестрСведенийВФССОПособияхПриРожденииРебенкаРаботникиОрганизации.АдресПочтовыйКодПоФИАС,
	|	РеестрСведенийВФССОПособияхПриРожденииРебенкаРаботникиОрганизации.АдресРегистрацииКодПоФИАС
	|ИЗ
	...
	|	И РеестрСведенийВФССОПособияхПриРожденииРебенкаРаботникиОрганизации.Ссылка.Проведен
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	|	РеестрСведенийВФССОЕжемесячныхПособияхПоУходуРаботникиОрганизации.ФизЛицо,
	...
	|	РеестрСведенийВФССОЕжемесячныхПособияхПоУходуРаботникиОрганизации.НаличиеКартыМИР,
	|	РеестрСведенийВФССОЕжемесячныхПособияхПоУходуРаботникиОрганизации.НомерКартыМИР,
	...
	|	РеестрСведенийВФССОЕжемесячныхПособияхПоУходуРаботникиОрганизации.АдресРегистрацииКодПоКЛАДР,
	|	РеестрСведенийВФССОЕжемесячныхПособияхПоУходуРаботникиОрганизации.АдресПочтовыйКодПоФИАС,
	|	РеестрСведенийВФССОЕжемесячныхПособияхПоУходуРаботникиОрганизации.АдресРегистрацииКодПоФИАС
	|ИЗ
	...
	|	И РеестрСведенийВФССОЕжемесячныхПособияхПоУходуРаботникиОрганизации.Ссылка.Проведен
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ ПЕРВЫЕ 1
	|	ДокументСДанными.Физлицо,
	...
	|	ДокументыПособий.НаличиеКартыМИР,
	|	ДокументыПособий.НомерКартыМИР,
	...
	|	ДокументыПособий.АдресПочтовыйКодПоФИАС,
	|	ДокументыПособий.АдресРегистрацииКодПоФИАС
	|ПОМЕСТИТЬ ВТДанныеПоследнегоДокумента
	|ИЗ
	|	(ВЫБРАТЬ
	|		МАКСИМУМ(ДокументыПособий.Ссылка) КАК Ссылка,
	|		ДатаДокумента.Физлицо КАК Физлицо
	|	ИЗ
	|		(ВЫБРАТЬ
	|			МАКСИМУМ(ДокументыПособий.Дата) КАК Дата,
	|			ДокументыПособий.Физлицо КАК Физлицо
	|		ИЗ
	...
	|		
	|		СГРУППИРОВАТЬ ПО
	|			ДокументыПособий.Физлицо) КАК ДатаДокумента
	|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВТДокументыПособий КАК ДокументыПособий
	|			ПО ДатаДокумента.Дата = ДокументыПособий.Дата
	|				И ДатаДокумента.Физлицо = ДокументыПособий.Физлицо
	|	
	|	СГРУППИРОВАТЬ ПО
	|		ДатаДокумента.Физлицо) КАК ДокументСДанными
	...
	|		ГДЕ
	|			ДокументыПособий.Дата < &Дата
	|			И ДокументыПособий.ДатаВыдачиДокументаНаПроживание <> ДАТАВРЕМЯ(1, 1, 1)
	|		
	|		СГРУППИРОВАТЬ ПО
	|			ДокументыПособий.Физлицо) КАК ДатаДокумента
	|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВТДокументыПособий КАК ДокументыПособий
	...
	|	ВЫБОР
	|		КОГДА ДанныеПоследнегоДокумента.АдресРегистрацииКодПоФИАС ЕСТЬ НЕ NULL 
	|			ТОГДА ДанныеПоследнегоДокумента.АдресРегистрацииКодПоФИАС
	|		ИНАЧЕ """"
	|	КОНЕЦ КАК АдресРегистрацииКодПоФИАС,
	|	ВЫБОР
	...
	|	ВЫБОР
	|		КОГДА ДанныеПоследнегоДокумента.АдресПочтовыйКодПоФИАС ЕСТЬ НЕ NULL 
	|			ТОГДА ДанныеПоследнегоДокумента.АдресПочтовыйКодПоФИАС
	|		ИНАЧЕ """"
	|	КОНЕЦ КАК АдресПочтовыйКодПоФИАС,
	|	ВЫБОР
	...
	|	ДанныеПоследнегоДокумента.НаличиеКартыМИР,
	|	ДанныеПоследнегоДокумента.НомерКартыМИР,
	...
	|		ПО Физлица.Физлицо = ДанныеПоследнегоДокумента.Физлицо
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТДанныеПоследнегоДокументаОПроживании КАК ДанныеПоследнегоДокументаОПроживании
	|		ПО Физлица.Физлицо = ДанныеПоследнегоДокументаОПроживании.Физлицо
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТДанныеЗарплатногоСчета КАК ДанныеЗарплатногоСчета
	|		ПО Физлица.Физлицо = ДанныеЗарплатногоСчета.ФизЛицо";
	...
	Если Режим = "ДляДокумента" Тогда
		...
		ДанныеСотрудника = Новый Структура("Фамилия, Имя, Отчество, АдресПочтовый, АдресПочтовыйКодПоКЛАДР, АдресПочтовыйКодПоФИАС, АдресРегистрации, АдресРегистрацииКодПоКЛАДР, АдресРегистрацииКодПоФИАС, Телефон"
		...
		Если Выборка.Следующий() Тогда
			...
			Если ЗначениеЗаполнено(ДанныеСотрудника.АдресПочтовый) И Не ЗначениеЗаполнено(ДанныеСотрудника.АдресПочтовыйКодПоКЛАДР) Тогда
			...
			КонецЕсли;
			Если ЗначениеЗаполнено(ДанныеСотрудника.АдресРегистрации) И Не ЗначениеЗаполнено(ДанныеСотрудника.АдресРегистрацииКодПоКЛАДР) Тогда
	...
	Иначе
		...
		Для каждого ДанныеСотрудника Из ТаблицаРезультата Цикл
			Если ЗначениеЗаполнено(ДанныеСотрудника.АдресПочтовый) И Не ЗначениеЗаполнено(ДанныеСотрудника.АдресПочтовыйКодПоКЛАДР) Тогда
				 ДанныеСотрудника.АдресПочтовыйКодПоКЛАДР = ОбменСведениямиОПособияхСФСС.КодАдресаПоКЛАДРдляФСС(ДанныеСотрудника.АдресПочтовый)
			КонецЕсли;
			Если ЗначениеЗаполнено(ДанныеСотрудника.АдресРегистрации) И Не ЗначениеЗаполнено(ДанныеСотрудника.АдресРегистрацииКодПоКЛАДР) Тогда
