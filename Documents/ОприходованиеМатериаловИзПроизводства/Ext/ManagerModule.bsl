...
Функция ПечатьОприходованияМатериалов(МассивОбъектов, ОбъектыПечати, ИмяМакета = "Накладная")
	...
	Для Каждого Ссылка Из МассивОбъектов Цикл
	    ...
	    Если МестВсего = 0 Тогда
			...
			ОбластьПодписи = Макет.ПолучитьОбласть("ПодписиБезМест");
		Иначе
...
Функция ПечатьМ4(МассивОбъектов, ОбъектыПечати)
	...
	|		СУММА(ОприходованиеМатериаловИзПроизводства.Сумма) КАК Сумма,
	|		СУММА(ОприходованиеМатериаловИзПроизводства.СуммаРегл) КАК СуммаРегл,
