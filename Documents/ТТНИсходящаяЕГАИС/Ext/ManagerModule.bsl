...
Функция КвитанцияПодтвержденияАктаРасхожденийXML(ДокументСсылка)
	...
	// КвитанцияАктаРасхожденийПодтверждение
...
Функция КвитанцияПодтверждениеЗапросаНаОтменуПроведенияXML(ДокументСсылка)
	...
	// КвитанцияЗапросаНаОтменуПроведенияТТНПодтверждение
...
Функция КвитанцияОтказаОтЗапросаНаОтменуПроведенияXML(ДокументСсылка)
	...
	// КвитанцияЗапросаНаОтменуПроведенияТТНОтказ
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(МассивСсылок) Экспорт
	...
	|	СоответствиеНоменклатурыЕГАИС.ЕдиницаИзмерения КАК Упаковка,
	...
	|	ВтСопоставленнаяНоменклатура.Упаковка КАК Упаковка,
	...
	|	ВТСопоставлено.Упаковка КАК Упаковка
	|ИЗ
	|	ВТАлкогольнаяПродукция КАК ВТАлкогольнаяПродукция
	...
	Пока ВыборкаПоДокументам.Следующий() Цикл
		...
		Пока ВыборкаПоТоварам.Следующий() Цикл
			Если ЗначениеЗаполнено(ВыборкаПоТоварам.Номенклатура) Тогда
				...
				СтрокаТЧ.Упаковка = ВыборкаПоТоварам.Упаковка;
