...
Функция ПечатьИНВ19()
	...
	Пока ВыборкаСтрокТовары.Следующий() Цикл
		...
		Если Разница < 0 И РазницаСумм < 0 Тогда
			...
			ИтогоРезультатПоСтраницеНедостачаКолво = ИтогоРезультатПоСтраницеНедостачаКолво + (- Разница);
			ИтогоРезультатПоСтраницеНедостачаСумма = ИтогоРезультатПоСтраницеНедостачаСумма + (- РазницаСумм);
		...
		Иначе
			...
			ИтогоРезультатПоСтраницеИзлишекКолво   = ИтогоРезультатПоСтраницеИзлишекКолво   + Разница;
			ИтогоРезультатПоСтраницеИзлишекСумма   = ИтогоРезультатПоСтраницеИзлишекСумма   + РазницаСумм;
		КонецЕсли;
