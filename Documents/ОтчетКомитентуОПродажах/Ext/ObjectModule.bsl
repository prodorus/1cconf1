...
Функция ПолучитьСтруктуруПечатныхФорм() Экспорт
	...
	СтруктураПечатныхФорм.Вставить("ОтчетКомитентуОПродажах",    		"Отчет комитенту");
	СтруктураПечатныхФорм.Вставить("АктОбОказанииУслуг",    			"Акт об оказании услуг");
...
Функция ОпределитьСчетФактураТребуется() Экспорт 
	...
	ЕстьНДС = (Товары.Итог("СуммаНДСВознаграждения") > 0);
