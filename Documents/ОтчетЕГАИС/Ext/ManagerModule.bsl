...
Функция ЗапросОтчетЕГАИСXML(ДокументСсылка)
	...
	// ЗапросОтчетаДвиженияМеждуРегистрами
	...
	// ЗапросОтчетаДвиженияПоСправке2
	...
	// ЗапросОтчетаИнформацияОбОрганизации
