...
Функция ПредставлениеКонтрагента(Строка, Представление) Экспорт
	...
	ПредставлениеИНН = ПодставитьПараметрыВСтроку(НСтр("ru = '%1'"), Строка.ИНН);
	
	Если ЗначениеЗаполнено(Представление) Тогда
		Возврат ПодставитьПараметрыВСтроку(НСтр("ru = '%1 (%2)'"), ПредставлениеИНН, Представление);
	Иначе
...
Функция КонтрагентыПоСпискуИНН(ТаблицаИННиКПП) Экспорт
	...
	КонтрагентыДоступны = СправочникКонтрагентовДоступен();
...
Функция СведенияОКонтрагентеПоСсылке(Контрагент) Экспорт
	...
	Если КонтрагентыДоступны Тогда
		ИНН = ЗначениеРеквизитаОбъекта(Контрагент, "ИНН");
		КПП = ЗначениеРеквизитаОбъекта(Контрагент, "КПП");
...
Функция СведенияОКонтрагентеПоТаблицеКонтрагентов(ИНН, ТаблицаКонтрагентов, КПП = "") Экспорт
	...
	Если ТаблицаКонтрагентов <> Неопределено Тогда
		...
		КонецЦикла;
		ПредставлениеКонтрагента = ПолучитьСтрокуИзМассиваПодстрок(МассивПредставлений, ";");
	КонецЕсли;
...
//////////////////////////////////////////////////////////////////////////////////////
// СПИСКИ ПОСРЕДНИЧЕСКОЙ ДЕЯТЕЛЬНОСТИ
...
Функция ДанныеПоясненияКДекларацииПоНДС(Пояснение) Экспорт
	...
	ДанныеПоясненияКДекларацииПоНДС.Вставить("ПояснИнОсн", ЗначениеРеквизитаОбъекта(Пояснение, "ПояснИнОсн"));
...
Функция ТаблицаРаздела8() Экспорт
	...
	Раздел8.Колонки.Добавить("НомерПор", ОписаниеТипаЧисло(12, 0));
	
	Раздел8.Колонки.Добавить("НомСчФПрод", ОписаниеТипаСтрока(0));
	Раздел8.Колонки.Добавить("ДатаСчФПрод", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	Раздел8.Колонки.Добавить("НомИспрСчФ", ОписаниеТипаЧисло(3, 0));
	Раздел8.Колонки.Добавить("ДатаИспрСчФ", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	Раздел8.Колонки.Добавить("НомКСчФПрод", ОписаниеТипаСтрока(0));
	Раздел8.Колонки.Добавить("ДатаКСчФПрод", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	Раздел8.Колонки.Добавить("НомИспрКСчФ", ОписаниеТипаЧисло(3, 0));
	Раздел8.Колонки.Добавить("ДатаИспрКСчФ", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	Раздел8.Колонки.Добавить("НомТД", ОписаниеТипаСтрока(0));
	Раздел8.Колонки.Добавить("ОКВ", ОписаниеТипаСтрока(3));
	
	Раздел8.Колонки.Добавить("СтоимПокупВ", ОписаниеТипаЧисло(19, 2));
	Раздел8.Колонки.Добавить("СумНДСВыч", ОписаниеТипаЧисло(19, 2));
	...
	Раздел8.Колонки.Добавить("СвПос", ОписаниеТипаСтрока(12));
...
Функция ТаблицаРаздела9() Экспорт
	...
	Раздел9.Колонки.Добавить("НомерПор", ОписаниеТипаЧисло(12, 0));
	
	Раздел9.Колонки.Добавить("НомСчФПрод", ОписаниеТипаСтрока(0));
	Раздел9.Колонки.Добавить("ДатаСчФПрод", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	Раздел9.Колонки.Добавить("НомИспрСчФ", ОписаниеТипаЧисло(3, 0));
	Раздел9.Колонки.Добавить("ДатаИспрСчФ", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	Раздел9.Колонки.Добавить("НомКСчФПрод", ОписаниеТипаСтрока(0));
	Раздел9.Колонки.Добавить("ДатаКСчФПрод", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	Раздел9.Колонки.Добавить("НомИспрКСчФ", ОписаниеТипаЧисло(3, 0));
	Раздел9.Колонки.Добавить("ДатаИспрКСчФ", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	Раздел9.Колонки.Добавить("ОКВ", ОписаниеТипаСтрока(3));
	
	Раздел9.Колонки.Добавить("СтоимПродСФВ", ОписаниеТипаЧисло(19, 2));
	Раздел9.Колонки.Добавить("СтоимПродСФ20", ОписаниеТипаЧисло(19, 2));
	Раздел9.Колонки.Добавить("СтоимПродСФ18", ОписаниеТипаЧисло(19, 2));
	Раздел9.Колонки.Добавить("СтоимПродСФ10", ОписаниеТипаЧисло(19, 2));
	Раздел9.Колонки.Добавить("СтоимПродСФ0", ОписаниеТипаЧисло(19, 2));
	Раздел9.Колонки.Добавить("СумНДССФ20", ОписаниеТипаЧисло(19, 2));
	Раздел9.Колонки.Добавить("СумНДССФ18", ОписаниеТипаЧисло(19, 2));
	Раздел9.Колонки.Добавить("СумНДССФ10", ОписаниеТипаЧисло(19, 2));
	Раздел9.Колонки.Добавить("СтоимПродОсв", ОписаниеТипаЧисло(19, 2));
	...
	Раздел9.Колонки.Добавить("СвПос", ОписаниеТипаСтрока(12));
...
Функция ТаблицаРаздела10() Экспорт
	...
	Раздел10.Колонки.Добавить("НомерПор", ОписаниеТипаЧисло(12, 0));
	
	Раздел10.Колонки.Добавить("НомСчФПрод", ОписаниеТипаСтрока(0));
	Раздел10.Колонки.Добавить("ДатаСчФПрод", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	Раздел10.Колонки.Добавить("НомИспрСчФ", ОписаниеТипаЧисло(3, 0));
	Раздел10.Колонки.Добавить("ДатаИспрСчФ", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	Раздел10.Колонки.Добавить("НомКСчФПрод", ОписаниеТипаСтрока(0));
	Раздел10.Колонки.Добавить("ДатаКСчФПрод", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	Раздел10.Колонки.Добавить("НомИспрКСчФ", ОписаниеТипаЧисло(3, 0));
	Раздел10.Колонки.Добавить("ДатаИспрКСчФ", ОписаниеТипаДата(ЧастиДаты.Дата));
	...
	Раздел10.Колонки.Добавить("СвПокуп", ОписаниеТипаСтрока(12));
...
Функция ТаблицаРаздела11() Экспорт
	...
	Раздел11.Колонки.Добавить("НомерПор", ОписаниеТипаЧисло(12, 0));
	
	Раздел11.Колонки.Добавить("НомСчФПрод", ОписаниеТипаСтрока(0));
	Раздел11.Колонки.Добавить("ДатаСчФПрод", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	Раздел11.Колонки.Добавить("НомИспрСчФ", ОписаниеТипаЧисло(3, 0));
	Раздел11.Колонки.Добавить("ДатаИспрСчФ", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	Раздел11.Колонки.Добавить("НомКСчФПрод", ОписаниеТипаСтрока(0));
	Раздел11.Колонки.Добавить("ДатаКСчФПрод", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	Раздел11.Колонки.Добавить("НомИспрКСчФ", ОписаниеТипаЧисло(3, 0));
	Раздел11.Колонки.Добавить("ДатаИспрКСчФ", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	Раздел11.Колонки.Добавить("КодВидСд", ОписаниеТипаСтрока(1));
	Раздел11.Колонки.Добавить("ОКВ", ОписаниеТипаСтрока(3));
	
	Раздел11.Колонки.Добавить("СтоимТовСчФВс", ОписаниеТипаЧисло(19, 2));
	Раздел11.Колонки.Добавить("СумНДССчФ", ОписаниеТипаЧисло(19, 2));
	
	Раздел11.Колонки.Добавить("РазСтКСчФУм", ОписаниеТипаЧисло(19, 2));
	Раздел11.Колонки.Добавить("РазСтКСчФУв", ОписаниеТипаЧисло(19, 2));
	Раздел11.Колонки.Добавить("РазНДСКСчФУм", ОписаниеТипаЧисло(19, 2));
	Раздел11.Колонки.Добавить("РазНДСКСчФУв", ОписаниеТипаЧисло(19, 2));
	...
	Раздел11.Колонки.Добавить("СвПрод", ОписаниеТипаСтрока(12));
	Раздел11.Колонки.Добавить("СвКомис", ОписаниеТипаСтрока(12));
...
Функция ТаблицаРаздела12() Экспорт
	...
	Раздел12.Колонки.Добавить("НомСчФ",         ОписаниеТипаСтрока(0));
	Раздел12.Колонки.Добавить("ДатаСчФ",        ОписаниеТипаДата(ЧастиДаты.Дата));
	Раздел12.Колонки.Добавить("ОКВ",            ОписаниеТипаСтрока(3));
	Раздел12.Колонки.Добавить("СтоимТовБНалВс", ОписаниеТипаЧисло(19, 2));
	Раздел12.Колонки.Добавить("СумНалПокуп",    ОписаниеТипаЧисло(19, 2));
	Раздел12.Колонки.Добавить("СтоимТовСНалВс", ОписаниеТипаЧисло(19, 2));
	Раздел12.Колонки.Добавить("СпрКодОш",       Новый ОписаниеТипов("Массив"));
	Раздел12.Колонки.Добавить("СвПокуп",        ОписаниеТипаСтрока(12));
...
Процедура ЗаполнитьРаздел8(Объект, ДанныеТребования, ОтправленныеРанееСтроки, ДанныеКопирования) Экспорт
	...
	Для Каждого СтрокаТаблицыРаздела Из ТаблицаРаздела Цикл
		...
		ЗаписьКнигиПокупок.КодВидаОперации           = ПолучитьСтрокуИзМассиваПодстрок(СтрокаТаблицыРаздела.КодВидОпер, ";");
...
Процедура ЗаполнитьРаздел9(Объект, ДанныеТребования, ОтправленныеРанееСтроки, ДанныеКопирования) Экспорт
	...
	Для Каждого СтрокаТаблицыРаздела Из ТаблицаРаздела Цикл
		...
		ЗаписьКнигиПродаж.КодВидаОперации           = ПолучитьСтрокуИзМассиваПодстрок(СтрокаТаблицыРаздела.КодВидОпер, ";");
...
Процедура ЗаполнитьРаздел10(Объект, ДанныеТребования, ОтправленныеРанееСтроки, ДанныеКопирования) Экспорт
	...
	Для Каждого СтрокаТаблицыРаздела Из ТаблицаРаздела Цикл
		...
		ЗаписьЖурнала.КодВидаОперации           = ПолучитьСтрокуИзМассиваПодстрок(СтрокаТаблицыРаздела.КодВидОпер, ";");
...
// 
Функция ПолучитьФайлВыгрузки(ДокументСсылка) Экспорт
	...
	Возврат КонтекстЭДО.ПолучитьФайлВыгрузкиОтветаНаТребованиеПоясненийКДекларацииНДС(ДанныеДляВыгрузки);
...
Процедура ЗаполнитьСтрокуРаздела8(СтрокаВыгрузкиРаздела8, ДанныеСтроки, СпискиРеквизитов, ПостфиксРеквизита)
	...
	СтрокаВыгрузкиРаздела8.КодВидОпер = ОбщегоНазначения.РазложитьСтрокуВМассивПодстрок(ДанныеСтроки["КодВидаОперации"+ПостфиксРеквизита], ";");
...
Процедура ЗаполнитьСтрокуРаздела9(СтрокаВыгрузкиРаздела9, ДанныеСтроки, СпискиРеквизитов, ПостфиксРеквизита)
	...
	СтрокаВыгрузкиРаздела9.КодВидОпер = ОбщегоНазначения.РазложитьСтрокуВМассивПодстрок(ДанныеСтроки["КодВидаОперации"+ПостфиксРеквизита], ";");
...
Процедура ЗаполнитьСтрокуРаздела10(СтрокаВыгрузкиРаздела10, ДанныеСтроки, СпискиРеквизитов, ПостфиксРеквизита)
	...
	СтрокаВыгрузкиРаздела10.КодВидОпер = ОбщегоНазначения.РазложитьСтрокуВМассивПодстрок(ДанныеСтроки["КодВидаОперации"+ПостфиксРеквизита], ";");
...
Процедура ЗаполнитьСтрокуРаздела11(СтрокаВыгрузкиРаздела11, ДанныеСтроки, ПостфиксРеквизита)
	...
	СтрокаВыгрузкиРаздела11.КодВидОпер = ОбщегоНазначения.РазложитьСтрокуВМассивПодстрок(ДанныеСтроки["КодВидаОперации"+ПостфиксРеквизита], ";");
...
Функция СтруктураОтветНаТребование()
	...
	ОтветНаТребование.Вставить("ПояснИнОсн", ОписаниеТипаСтрока(0));
...
Функция ТаблицаКнигаПокупок()
	...
	КнигаПокупок.Колонки.Добавить("НомерПор", ОписаниеТипаЧисло(12, 0));
	
	КнигаПокупок.Колонки.Добавить("НомСчФПрод", ОписаниеТипаСтрока(0));
	КнигаПокупок.Колонки.Добавить("ДатаСчФПрод", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	КнигаПокупок.Колонки.Добавить("НомИспрСчФ", ОписаниеТипаЧисло(3, 0));
	КнигаПокупок.Колонки.Добавить("ДатаИспрСчФ", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	КнигаПокупок.Колонки.Добавить("НомКСчФПрод", ОписаниеТипаСтрока(0));
	КнигаПокупок.Колонки.Добавить("ДатаКСчФПрод", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	КнигаПокупок.Колонки.Добавить("НомИспрКСчФ", ОписаниеТипаЧисло(3, 0));
	КнигаПокупок.Колонки.Добавить("ДатаИспрКСчФ", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	КнигаПокупок.Колонки.Добавить("НомТД", ОписаниеТипаСтрока(0));
	КнигаПокупок.Колонки.Добавить("ОКВ", ОписаниеТипаСтрока(3));
	
	КнигаПокупок.Колонки.Добавить("СтоимПокупВ", ОписаниеТипаЧисло(19, 2));
	...
	КнигаПокупок.Колонки.Добавить("СвПос", ОписаниеТипаСтрока(12));
...
Функция ТаблицаКнигаПродаж()
	...
	КнигаПродаж.Колонки.Добавить("НомерПор", ОписаниеТипаЧисло(12, 0));
	
	КнигаПродаж.Колонки.Добавить("НомСчФПрод", ОписаниеТипаСтрока(0));
	КнигаПродаж.Колонки.Добавить("ДатаСчФПрод", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	КнигаПродаж.Колонки.Добавить("НомИспрСчФ", ОписаниеТипаЧисло(3, 0));
	КнигаПродаж.Колонки.Добавить("ДатаИспрСчФ", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	КнигаПродаж.Колонки.Добавить("НомКСчФПрод", ОписаниеТипаСтрока(0));
	КнигаПродаж.Колонки.Добавить("ДатаКСчФПрод", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	КнигаПродаж.Колонки.Добавить("НомИспрКСчФ", ОписаниеТипаЧисло(3, 0));
	КнигаПродаж.Колонки.Добавить("ДатаИспрКСчФ", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	КнигаПродаж.Колонки.Добавить("ОКВ", ОписаниеТипаСтрока(3));
	
	КнигаПродаж.Колонки.Добавить("СтоимПродСФВ", ОписаниеТипаЧисло(19, 2));
	...
	КнигаПродаж.Колонки.Добавить("СвПос", ОписаниеТипаСтрока(12));
...
Функция ТаблицаЖурналУчетаВыставленныхСФ()
	...
	ЖурналУчетаВыставленныхСФ.Колонки.Добавить("НомерПор", ОписаниеТипаЧисло(12, 0));
	
	ЖурналУчетаВыставленныхСФ.Колонки.Добавить("НомСчФПрод", ОписаниеТипаСтрока(0));
	ЖурналУчетаВыставленныхСФ.Колонки.Добавить("ДатаСчФПрод", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	ЖурналУчетаВыставленныхСФ.Колонки.Добавить("НомИспрСчФ", ОписаниеТипаЧисло(3, 0));
	ЖурналУчетаВыставленныхСФ.Колонки.Добавить("ДатаИспрСчФ", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	ЖурналУчетаВыставленныхСФ.Колонки.Добавить("НомКСчФПрод", ОписаниеТипаСтрока(0));
	ЖурналУчетаВыставленныхСФ.Колонки.Добавить("ДатаКСчФПрод", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	ЖурналУчетаВыставленныхСФ.Колонки.Добавить("НомИспрКСчФ", ОписаниеТипаЧисло(3, 0));
	ЖурналУчетаВыставленныхСФ.Колонки.Добавить("ДатаИспрКСчФ", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	ЖурналУчетаВыставленныхСФ.Колонки.Добавить("КодВидОпер", Новый ОписаниеТипов("Массив"));
	
	ЖурналУчетаВыставленныхСФ.Колонки.Добавить("СвПокуп", ОписаниеТипаСтрока(12));
...
Функция ТаблицаЖурналУчетаПолученныхСФ()
	...
	ЖурналУчетаПолученныхСФ.Колонки.Добавить("НомерПор", ОписаниеТипаЧисло(12, 0));
	
	ЖурналУчетаПолученныхСФ.Колонки.Добавить("НомСчФПрод", ОписаниеТипаСтрока(0));
	ЖурналУчетаПолученныхСФ.Колонки.Добавить("ДатаСчФПрод", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	ЖурналУчетаПолученныхСФ.Колонки.Добавить("НомИспрСчФ", ОписаниеТипаЧисло(3, 0));
	ЖурналУчетаПолученныхСФ.Колонки.Добавить("ДатаИспрСчФ", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	ЖурналУчетаПолученныхСФ.Колонки.Добавить("НомКСчФПрод", ОписаниеТипаСтрока(0));
	ЖурналУчетаПолученныхСФ.Колонки.Добавить("ДатаКСчФПрод", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	ЖурналУчетаПолученныхСФ.Колонки.Добавить("НомИспрКСчФ", ОписаниеТипаЧисло(3, 0));
	ЖурналУчетаПолученныхСФ.Колонки.Добавить("ДатаИспрКСчФ", ОписаниеТипаДата(ЧастиДаты.Дата));
	
	ЖурналУчетаПолученныхСФ.Колонки.Добавить("КодВидСд", ОписаниеТипаСтрока(1));
	ЖурналУчетаПолученныхСФ.Колонки.Добавить("ОКВ", ОписаниеТипаСтрока(3));
	
	ЖурналУчетаПолученныхСФ.Колонки.Добавить("СтоимТовСчФВс", ОписаниеТипаЧисло(19, 2));
	
	ЖурналУчетаПолученныхСФ.Колонки.Добавить("КодВидОпер", Новый ОписаниеТипов("Массив"));
	ЖурналУчетаПолученныхСФ.Колонки.Добавить("СвПрод", ОписаниеТипаСтрока(12));
	ЖурналУчетаПолученныхСФ.Колонки.Добавить("СвКомис", ОписаниеТипаСтрока(12));
...
Функция ТаблицаВыставленныеСФ_173_5()
	...
	ВыставленныеСФ_173_5.Колонки.Добавить("НомерПор",       ОписаниеТипаЧисло(12, 0));
	ВыставленныеСФ_173_5.Колонки.Добавить("НомСчФ",         ОписаниеТипаСтрока(0));
	ВыставленныеСФ_173_5.Колонки.Добавить("ДатаСчФ",        ОписаниеТипаДата(ЧастиДаты.Дата));
	ВыставленныеСФ_173_5.Колонки.Добавить("ОКВ",            ОписаниеТипаСтрока(3));
	ВыставленныеСФ_173_5.Колонки.Добавить("СтоимТовБНалВс", ОписаниеТипаЧисло(19, 2));
	ВыставленныеСФ_173_5.Колонки.Добавить("СтоимТовСНалВс", ОписаниеТипаЧисло(19, 2));
	ВыставленныеСФ_173_5.Колонки.Добавить("СвПокуп",        ОписаниеТипаСтрока(12));
...
Функция НеКнПрСтрТип()
	...
	НеКнПрСтрТип.Колонки.Добавить("НомерСтроки",  ОписаниеТипаЧисло(19, 0));
	НеКнПрСтрТип.Колонки.Добавить("НомСчФПрод",   ОписаниеТипаСтрока(0));
	НеКнПрСтрТип.Колонки.Добавить("ДатаСчФПрод",  ОписаниеТипаДата(ЧастиДаты.Дата));
	НеКнПрСтрТип.Колонки.Добавить("СтоимПродСФВ", ОписаниеТипаЧисло(19, 2));
	НеКнПрСтрТип.Колонки.Добавить("СтоимПродСФ",  ОписаниеТипаЧисло(19, 2));
	НеКнПрСтрТип.Колонки.Добавить("Раздел",       ОписаниеТипаСтрока(3));
	...
	НеКнПрСтрТип.Колонки.Добавить("КодВидОпер",   ОписаниеТипаСтрока(2));
...
Функция НеподтвЗаписи()
	...
	НеподтвЗаписи.Колонки.Добавить("НомСчФПрод", 	ОписаниеТипаСтрока(0));
	НеподтвЗаписи.Колонки.Добавить("ДатаСчФПрод", 	ОписаниеТипаДата(ЧастиДаты.Дата));
...
Функция ТаблицаСведКС()
	...
	ТаблицаСведКС.Колонки.Добавить("НомКС",       ОписаниеТипаСтрока(6));
	ТаблицаСведКС.Колонки.Добавить("ПоясненКС",   ОписаниеТипаСтрока(0));
...
Функция ТаблицаТребованияСведКС() Экспорт
	...
	СведКС.Колонки.Добавить("НомерКС",   	ОписаниеТипаСтрока(6));
	СведКС.Колонки.Добавить("ФормулНаруш",  ОписаниеТипаСтрока(2500));
	СведКС.Колонки.Добавить("НормаЗакон",  	ОписаниеТипаСтрока(1000));
	СведКС.Колонки.Добавить("КС",  			ОписаниеТипаСтрока(1000));
	СведКС.Колонки.Добавить("ДанДеклар",  	ОписаниеТипаСтрока(1000));
	...
	Для Каждого СтрокаТаблицыРаздела Из ТаблицаРаздела Цикл
		...
		Для каждого СтрокаСведСчФ Из СведСчФ Цикл
			...
			Иначе
				...
				ФИО = СтрокаИзМассиваПодстрок(ФИО, " ", Истина);
...
Функция ПредставлениеОшибкиРазделов(КодОшибки, ГрафаОшибки, Раздел, ВерсияФоматаТребования = Неопределено) Экспорт
	
	КодыОшибок = ОбщегоНазначения.РазложитьСтрокуВМассивПодстрок(КодОшибки, ";");
	...
	МассивОшибок = СтрокаИзМассиваПодстрок(МассивОшибок, Символы.ПС, Истина);
...
Функция ПредставлениеОшибкиРаздела8_Код4(ГрафаОшибки)
	...
	МассивГраф = ОбщегоНазначения.РазложитьСтрокуВМассивПодстрок(ГрафаОшибки, ";");
	МассивПредставлений = Новый Массив;
	Для Каждого Графа Из МассивГраф Цикл
		...
		КонецЕсли;
	КонецЦикла;
	ГрафыОшибки = ПолучитьСтрокуИзМассиваПодстрок(МассивПредставлений, ", ");
	...
	КонецЕсли;
	ПредставлениеОшибки = ПодставитьПараметрыВСтроку(СообщениеОбОшибке, ГрафыОшибки);
...
Функция ПредставлениеОшибкиРаздела9_Код4(ГрафаОшибки, ВерсияФоматаТребования)
	...
	БольшеИлиРавно_5_05 = КонтекстЭДО.СравнитьВерсииФормата(ВерсияФоматаТребования, "5.05") >= 0;
	...
	Для Каждого Графа Из МассивГраф Цикл
		...
		Иначе
			...
			Если БольшеИлиРавно_5_05 Тогда
				...
				// В формате 5.05 добавлены колонки:
...
Функция КодыОшибок(КодыОшибок)
	...
	МассивКодовОшибок = СтрокаИзМассиваПодстрок(МассивКодовОшибок, ";", Истина);
...
Функция ГрафыОшибок(КодыОшибок)
	...
	МассивГрафОшибок = СтрокаИзМассиваПодстрок(МассивГрафОшибок, ";", Истина);
...
Функция ПериодОтраженияЗаписи(ПериодЗап)
	...
	Если ТипЗнч(ПериодЗап) = Тип("Массив") Тогда
		...
		КонецЦикла;
		Результат = СтрокаИзМассиваПодстрок(Результат, ";", Истина);
		Возврат Результат;
...
Функция СправочникКонтрагентовДоступен() Экспорт
	...
	Если СправочникКонтрагенты = Неопределено Тогда
		Возврат Ложь;
	ИначеЕсли СправочникКонтрагенты.Реквизиты.Найти("ИНН") = Неопределено 
