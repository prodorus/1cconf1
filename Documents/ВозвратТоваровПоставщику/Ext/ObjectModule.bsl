...
Функция ПолучитьСтруктуруПечатныхФорм() Экспорт
	...
	СтруктураПечатныхФорм.Вставить("Накладная", 						"Возврат поставщику");
	СтруктураПечатныхФорм.Вставить("ТОРГ12", 							"ТОРГ-12 (Товарная накладная)");
	СтруктураПечатныхФорм.Вставить("УниверсальныйПередаточныйДокумент", "Универсальный передаточный документ (УПД)");
	СтруктураПечатныхФорм.Вставить("ТранспУпаковки", 					"Штрихкоды транспортных упаковок");
...
Функция ОпределитьСчетФактураТребуется() Экспорт 
	...
	Если ЗначениеЗаполнено(ДоговорКонтрагента) Тогда
		РеквизитыДоговора = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ДоговорКонтрагента, "УчетАгентскогоНДС, ВидДоговора");
	Иначе
		РеквизитыДоговора = Новый Структура("УчетАгентскогоНДС, ВидДоговора", Ложь, Неопределено);
	КонецЕсли;
