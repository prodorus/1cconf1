...
Функция СформироватьЗапросПоОтработанноеВремяВЦеломЗаПериод(ВыборкаПоШапкеДокумента)
	...
	|	ТаблицаДокумента.Сотрудник.Наименование КАК ПредставлениеСотрудника,
	...
	|ИЗ
	|	ВТОтработанноеВремяВЦеломЗаПериод КАК ТаблицаДокумента
	|		ЛЕВОЕ СОЕДИНЕНИЕ (ВЫБРАТЬ
	...
	|		ПО ТаблицаДокумента.Сотрудник = Дубли.Сотрудник
	|			И ТаблицаДокумента.ВидИспользованияРабочегоВремени = Дубли.ВидИспользованияРабочегоВремени
	|
	|УПОРЯДОЧИТЬ ПО
