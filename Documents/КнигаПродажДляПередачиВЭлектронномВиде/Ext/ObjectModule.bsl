...
Функция ЭлектронноеПредставление(УникальныйИдентификатор) Экспорт
	...
	Если НалоговыйПериод >= '2019-01-01' Тогда
		Возврат УчетНДСФормированиеОтчетности.ЭлектронноеПредставлениеКнигиПродаж_504(ЭтотОбъект, УникальныйИдентификатор);
	ИначеЕсли НалоговыйПериод >= '2017-10-01' Тогда
		Возврат УчетНДСФормированиеОтчетности.ЭлектронноеПредставлениеКнигиПродаж_503(ЭтотОбъект, УникальныйИдентификатор);
	ИначеЕсли НалоговыйПериод >= '2014-10-01' Тогда
		Возврат УчетНДСФормированиеОтчетности.ЭлектронноеПредставлениеКнигиПродаж_502(ЭтотОбъект, УникальныйИдентификатор);
	Иначе
		Возврат УчетНДСФормированиеОтчетности.ЭлектронноеПредставлениеКнигиПродаж_501(ЭтотОбъект, УникальныйИдентификатор);
	КонецЕсли;
