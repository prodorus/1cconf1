...
Функция АктРасхожденийXML(ДокументСсылка)
	...
	ПустыеЗначенияНоменклатуры = Справочники.Номенклатура.ПустаяСсылка();
...
// ЗавершениеСканированияАлкогольнойПродукции
...
// СлужебнаяЗавершениеСканированияАлкогольнойПродукции
