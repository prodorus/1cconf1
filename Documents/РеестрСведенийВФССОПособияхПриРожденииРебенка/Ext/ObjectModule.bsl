...
Функция Печать(ИмяМакета, КоличествоЭкземпляров = 1, НаПринтер = Ложь) Экспорт
	...
	Если Лев(ИмяМакета,33) = "ЗаявлениеВФССОВыплатеПособияБланк" Тогда // Бланк печатаем в любом случае, даже если отказ
		
		УточненноеИмяМакета = "ЗаявлениеВФССОВыплатеПособия" + ?(Дата < ОбменСведениямиОПособияхСФСС.ДатаВступленияВСилуФорм2012года(), "_2011", ?(Дата < ОбменСведениямиОПособияхСФСС.ДатаВступленияВСилуФорм2017года(), "_2012", "_2017"));
		ТабДокумент = ОбменСведениямиОПособияхСФСС.ПечатьЗаявлениеВФССОВыплатеПособия(ОбменСведениямиОПособияхСФСС.СтруктураДанныхДляПечатиЗаявленийВФССОВыплатеПособия(), УточненноеИмяМакета);
	...
	ИначеЕсли Лев(ИмяМакета,28) = "ЗаявлениеВФССОВыплатеПособия" И НЕ Отказ Тогда
		...
		Пока ВыборкаПоТЧРаботникиОрганизации.Следующий() Цикл
			...
			ТабДокументЗаявления = ОбменСведениямиОПособияхСФСС.ПечатьЗаявлениеВФССОВыплатеПособия(СтруктураДанных, УточненноеИмяМакета);
	...
	ИначеЕсли Лев(ИмяМакета,29) = "ОписьЗаявленийИДокументовВФСС" И НЕ Отказ Тогда
		...
		ТабДокумент = ОбменСведениямиОПособияхСФСС.ПечатьОписьЗаявленийИДокументовВФСС(ВыборкаПоШапкеДокумента, ВыборкаПоТЧРаботникиОрганизации, УточненноеИмяМакета);
	...
	ИначеЕсли Лев(ИмяМакета, 14) = "РеестрСведений" И НЕ Отказ Тогда
		...
		ТабДокумент = ПечатьРеестрСведенийВФСС(УточненноеИмяМакета, ВыборкаПоШапкеДокумента, ВыборкаПоТЧРаботникиОрганизации);
...
Функция ПолучитьСтруктуруПечатныхФорм() Экспорт
	...
	Возврат Новый Структура("ЗаявлениеВФССОВыплатеПособия, ЗаявлениеВФССОВыплатеПособияБланк, ОписьЗаявленийИДокументовВФСС, РеестрСведений", "Заявления о выплате пособия", "Бланк заявления", "Опись заявлений и документов", "Реестр сведений");
...
Функция СформироватьЗапросПоТЧРаботникиОрганизации() Экспорт
	...
	|	ВЫБОР
	|		КОГДА Пособия.НаличиеКартыМИР
	|			ТОГДА Пособия.НомерКартыМИР
	|		ИНАЧЕ """"
	...
	|						ТОГДА ""26""
	|					КОГДА Пособия.ВидСправкиОРожденииРебенка = ЗНАЧЕНИЕ(Перечисление.ВидыСправокОРожденииРебенка.ФормаНомер48)
	|						ТОГДА ""48""
	|					КОГДА Пособия.ВидСправкиОРожденииРебенка = ЗНАЧЕНИЕ(Перечисление.ВидыСправокОРожденииРебенка.ФормаНомер49)
	|						ТОГДА ""49""
	|					КОГДА Пособия.ВидСправкиОРожденииРебенка = ЗНАЧЕНИЕ(Перечисление.ВидыСправокОРожденииРебенка.ФормаНомер50)
	|						ТОГДА ""50""
	|					КОГДА Пособия.ВидСправкиОРожденииРебенка = ЗНАЧЕНИЕ(Перечисление.ВидыСправокОРожденииРебенка.ФормаНомер51)
	|						ТОГДА ""51""
	|					ИНАЧЕ """"
	|				КОНЕЦ
	...
	|	Пособия.Перерасчет,
	|	Пособия.Перерасчет КАК ЭтоПерерасчет,
