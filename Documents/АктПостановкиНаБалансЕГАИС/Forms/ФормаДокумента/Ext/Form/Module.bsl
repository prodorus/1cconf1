...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	СобытияФормЕГАИСКлиентПереопределяемый.ОбработкаВыбораНоменклатуры(
		ОписаниеОповещенияЕГАИС("Подключаемый_ОбработкаВыбораНоменклатуры", ЭтаФорма),
		ВыбранноеЗначение, ИсточникВыбора);
...
Процедура ОткрытьФормуСканированияАлкогольнойПродукции()
	...
	ОписаниеОповещенияОкончаниеПроверки = ОписаниеОповещенияЕГАИС("СканированиеАлкогольнойПродукцииПослеЗакрытия", ЭтаФорма);
