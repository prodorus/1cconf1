...
Процедура ОбработкаУдаленияПроведения(Отказ)
	...
	ОчиститьТекстПодтверждения = Истина;
	Если ЭтотОбъект.ДополнительныеСвойства.Свойство("ОчиститьТекстПодтверждения") Тогда
		ОчиститьТекстПодтверждения = ЭтотОбъект.ДополнительныеСвойства.ОчиститьТекстПодтверждения;
	КонецЕсли;
	Если ОчиститьТекстПодтверждения Тогда
		ТекстПодтверждения = "";
	КонецЕсли;
