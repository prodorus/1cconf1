...
Функция ПолучитьТекстЗапросаЗаказСУчетомИзменений(ИмяТабличнойЧасти, Запрос)
	...
	ТекстЗапроса	= 
		...
		|	, ВЫБОР 
		|		КОГДА ПолныйЗаказ.ЗначениеУсловияАвтоматическойСкидки = 0
		|		ТОГДА Неопределено
		|		ИНАЧЕ ПолныйЗаказ.ЗначениеУсловияАвтоматическойСкидки
		|	  КОНЕЦ КАК ЗначениеУсловияАвтоматическойСкидки
